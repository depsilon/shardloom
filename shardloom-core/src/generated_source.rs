...
//! dataset. Current support admits scoped local JSONL/CSV and feature-gated flat scalar structured
//! generated-output runtime; broader SQL/DataFrame, object-store, Foundry, production, and
...
impl GeneratedSourceSupportStatus {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::RuntimeSupported => "runtime-supported",
...
impl GeneratedSourceCertificateContractRow {
    ...
    pub const fn user_generated_source() -> Self {
        Self {
            ...
            support_status: GeneratedSourceSupportStatus::RuntimeSupported,
            generated_source_certificate_status:
            ...
            required_generator_kinds: "python_rows(runtime_local_jsonl_csv_structured),literal_table(runtime_local_jsonl_csv_structured),calendar(runtime_local_jsonl_csv_structured)",
            ...
            claim_boundary: "User-generated source support admits scoped local user_rows, literal_table, and calendar JSONL/CSV plus feature-gated flat scalar structured generated-output runtime; broader sink, platform, production, and performance claims remain blocked.",
            fallback_attempted: false,
            external_engine_invoked: false,
        }
    }
    ...
    pub const fn engine_native_generated_source() -> Self {
        Self {
            ...
            source_native_io_certificate_status: "not_applicable_no_source_dataset",
            output_native_io_certificate_status: "required_for_runtime_output",
            required_generator_kinds: "range(runtime_local_jsonl_csv_structured),sequence(runtime_local_jsonl_csv_structured),values(runtime_local_jsonl_csv_structured),literal_select(runtime_local_jsonl_csv_structured),generate_series(runtime_local_jsonl_csv_structured),synthetic(report_only)",
            ...
            blocker_id: "none_scoped_local_range_sequence_values_jsonl_csv_structured_runtime",
            claim_gate_status: "not_claim_grade",
            claim_boundary: "Engine-native generated source support admits scoped local range, sequence, SQL VALUES/literal, and generate_series/range JSONL/CSV plus feature-gated flat scalar structured generated-output runtime; synthetic, object-store, Foundry, production, and performance claims remain blocked/report-only.",
            fallback_attempted: false,
            external_engine_invoked: false,
        }
    }
...
impl GeneratedSourceCertificateContractReport {
    ...
    pub fn report_only() -> Self {
        Self {
            ...
            support_status_vocabulary: "smoke_only,runtime-supported,report_only,planned_runtime",
...
impl GeneratedSourceApiAdmissionRow {
    ...
    pub const fn python_ctx_from_rows() -> Self {
        Self {
            ...
            claim_gate_status: "not_claim_grade",
            claim_boundary: "Only scoped local user-row JSONL/CSV and feature-gated flat scalar structured generated-output runtime is admitted; no broad DataFrame, SQL, object-store, Foundry, production, or performance claim.",
            fallback_attempted: false,
            external_engine_invoked: false,
    ...
    pub const fn python_ctx_range() -> Self {
        Self {
            ...
            required_evidence: "generated_source_certificate,output_native_io_certificate,execution_certificate,no_fallback_evidence",
            claim_gate_status: "not_claim_grade",
            claim_boundary: "Only scoped local range JSONL/CSV and feature-gated flat scalar structured generated-output runtime is admitted; broad DataFrame, object-store, Foundry, production, and performance claims remain blocked.",
            fallback_attempted: false,
            external_engine_invoked: false,
            fallback_execution_allowed: false,
        }
    ...
    pub const fn python_ctx_sequence() -> Self {
        Self {
            ...
            required_evidence: "generated_source_certificate,output_native_io_certificate,execution_certificate,no_fallback_evidence",
            claim_gate_status: "not_claim_grade",
            claim_boundary: "Only scoped local sequence JSONL/CSV and feature-gated flat scalar structured generated-output runtime is admitted; broad DataFrame, object-store, Foundry, production, and performance claims remain blocked.",
            fallback_attempted: false,
            external_engine_invoked: false,
            fallback_execution_allowed: false,
        }
    ...
    pub const fn python_ctx_literal_table() -> Self {
        Self {
            ...
            claim_gate_status: "not_claim_grade",
            claim_boundary: "Only scoped local literal-table JSONL/CSV and feature-gated flat scalar structured generated-output runtime is admitted; broad DataFrame, object-store, Foundry, production, and performance claims remain blocked.",
            fallback_attempted: false,
            external_engine_invoked: false,
            fallback_execution_allowed: false,
        }
    ...
    pub const fn python_ctx_calendar() -> Self {
        Self {
            ...
            claim_gate_status: "not_claim_grade",
            claim_boundary: "Only scoped local calendar/date-dimension JSONL/CSV and feature-gated flat scalar structured generated-output runtime is admitted; broad SQL/DataFrame runtime, object-store, Foundry, production, and performance claims remain blocked.",
            fallback_attempted: false,
            external_engine_invoked: false,
            fallback_execution_allowed: false,
        }
    ...
    pub const fn python_generated_source_write() -> Self {
        Self {
            ...
            claim_gate_status: "not_claim_grade",
            claim_boundary: "Generated-source write is admitted only for supported local user_rows, literal_table, calendar, range, sequence, SQL VALUES, SQL literal SELECT, and SQL generate_series/range JSONL/CSV plus feature-gated flat scalar structured runtime; unsupported generator kinds remain blocked/report-only.",
            fallback_attempted: false,
            external_engine_invoked: false,
            fallback_execution_allowed: false,
        }
    ...
    pub const fn sql_literal_select() -> Self {
        Self {
            ...
            claim_gate_status: "not_claim_grade",
            claim_boundary: "SQL literal SELECT is admitted only for scoped source-free local JSONL/CSV and feature-gated flat scalar structured generated-output runtime; no broad SQL runtime claim.",
            fallback_attempted: false,
            external_engine_invoked: false,
            fallback_execution_allowed: false,
        }
    ...
    pub const fn sql_values() -> Self {
        Self {
            ...
            claim_gate_status: "not_claim_grade",
            claim_boundary: "SQL VALUES is admitted only for scoped source-free local JSONL/CSV and feature-gated flat scalar structured generated-output runtime; no broad SQL runtime claim.",
            fallback_attempted: false,
            external_engine_invoked: false,
            fallback_execution_allowed: false,
        }
    ...
    pub const fn sql_generate_series_range() -> Self {
        Self {
            ...
            claim_gate_status: "not_claim_grade",
            claim_boundary: "SQL generate_series/range is admitted only for SELECT * plus scoped value-column/int64 projections from generate_series/range(...) local JSONL/CSV and feature-gated flat scalar structured generated-output runtime; no broad SQL runtime claim.",
            fallback_attempted: false,
            external_engine_invoked: false,
            fallback_execution_allowed: false,
        }
...
impl GeneratedSourceEvidenceAlignmentRow {
    ...
    pub const fn python_generated_source() -> Self {
        Self {
            ...
            required_evidence: "generated_source_certificate,output_native_io_certificate,execution_certificate,no_fallback_evidence",
            claim_gate_status: "not_claim_grade",
            claim_boundary: "Scoped local JSONL/CSV and feature-gated flat scalar structured generated-output runtime only; lineage, telemetry, and confidence refs are report-only and cannot upgrade the claim.",
            fallback_attempted: false,
            external_engine_invoked: false,
        }
    }
...
mod tests {
    ...
    fn report_only_contract_separates_no_dataset_smoke_from_generated_output() {
        ...
        assert_eq!(user_rows.support_status.as_str(), "runtime-supported");
        assert!(user_rows.generated_source_created);
        assert!(user_rows.output_io_performed);
        assert!(
            user_rows
                .required_generator_kinds
                .contains("literal_table(runtime_local_jsonl_csv_structured)")
        );
        assert!(
            user_rows
                .required_generator_kinds
                .contains("calendar(runtime_local_jsonl_csv_structured)")
        );
        ...
        assert_eq!(engine_range.support_status.as_str(), "runtime-supported");
        assert!(engine_range.generated_source_created);
        assert!(engine_range.output_io_performed);
        assert_eq!(engine_range.claim_gate_status, "not_claim_grade");
        ...
        assert!(
            engine_range
                .claim_boundary
                .contains("range, sequence, SQL VALUES/literal")
        );
    }
    ...
    fn api_admission_matrix_classifies_supported_and_report_only_source_free_forms() {
        ...
        assert_eq!(from_rows.support_status.as_str(), "runtime-supported");
        ...
        assert_eq!(literal_table.support_status.as_str(), "runtime-supported");
        ...
        assert_eq!(calendar.support_status.as_str(), "runtime-supported");
        ...
        assert_eq!(sequence.support_status.as_str(), "runtime-supported");
        ...
        assert_eq!(sql_values.support_status.as_str(), "runtime-supported");
