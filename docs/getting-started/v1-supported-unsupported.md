...
| Surface | State | Feature gate | Runtime | Write | Claim gate | Boundary |
| --- | --- | --- | --- | --- | --- | --- |
| inline_jsonl, csv | executable | default | true | true | fixture_smoke_only | local fixture result output only; not production sink or transaction support |
