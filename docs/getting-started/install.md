...
ShardLoom v0.2.3 is the current proof-backed technical-preview package release. You can use either
...
| Install from published packages | [Package User Install Status](package-user-install.md) | v0.2.3 selected package channels are published and proof-backed |
...
GitHub release assets, PyPI, TestPyPI, and Homebrew are live for v0.2.3. That package access is not
a production, performance, broad SQL/DataFrame, or Spark-replacement claim.

The selected v0.2.3 package path is GitHub pre-release plus TestPyPI/PyPI and Homebrew. Scoop,
