...
| `python/README.md` | `first-10-minutes-local-smoke`, `python-wrapper-client-smoke`, `python-local-csv-query-builder-smoke`, `sql-dataframe-capability-posture`, `source-free-generated-output-boundary` |
