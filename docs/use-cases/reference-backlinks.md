...
| `docs/architecture/effectful-operation-admission-matrix.md` | `local-sqlite-udf-effectful-boundary` |
| `docs/architecture/extension-manifest-effect-capability-matrix.md` | `local-sqlite-udf-effectful-boundary` |
| `docs/architecture/io-reuse-and-fanout-architecture.md` | `output-result-sink-and-fanout-boundary` |
| `docs/architecture/object-store-request-planner.md` | `object-store-boundary-report`, `object-store-public-no-credential-fixture-read-smoke`, `object-store-local-emulator-read-smoke`, `object-store-local-emulator-write-smoke`, `local-table-append-commit-rehearsal-smoke` |
...
| `docs/architecture/universal-compatibility-coverage-scoreboard.md` | `local-sqlite-udf-effectful-boundary`, `object-store-boundary-report`, `table-lakehouse-boundary-report` |
| `docs/architecture/universal-ingress-route-taxonomy.md` | `vortex-ingest-prepare-once-local`, `local-sqlite-udf-effectful-boundary` |
| `docs/architecture/universal-input-contract.md` | `object-store-boundary-report`, `object-store-public-no-credential-fixture-read-smoke`, `table-lakehouse-boundary-report` |
| `docs/architecture/vortex-public-api-inventory.md` | `object-store-public-no-credential-fixture-read-smoke`, `object-store-local-emulator-read-smoke` |
