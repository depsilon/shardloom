...
feature-gated Parquet/Arrow IPC compatibility sinks; local Vortex typed decimal output and Avro/ORC
typed decimal sinks still block deterministically until their preservation/replay evidence exists.
