...
- P8.7A retro-future ShardLoom brand direction and visual identity system is recorded in
  ...
  continue below.
- P8.7B command-deck site shell and navigation overhaul is recorded in
  `docs/architecture/phased-execution-completed-ledger.md`; remaining P8.7 implementation slices
  continue below.
- P8.7C cyberpunk/space design tokens and CSS component refactor is recorded in
  `docs/architecture/phased-execution-completed-ledger.md`; remaining P8.7 implementation slices
  continue below.
- P8.7D homepage command-deck overhaul is recorded in
  `docs/architecture/phased-execution-completed-ledger.md`; remaining P8.7 implementation slices
  continue below.
- P8.7E retro-future field-guide page system is recorded in
  `docs/architecture/phased-execution-completed-ledger.md`; remaining P8.7 implementation slices
  continue below.
- P8.7F benchmark telemetry dashboard overhaul is recorded in
  `docs/architecture/phased-execution-completed-ledger.md`.
- P8.7G compute-flow mission-map overhaul is recorded in
  `docs/architecture/phased-execution-completed-ledger.md`.
- P8.7H launch-status board and public posture page is recorded in
  `docs/architecture/phased-execution-completed-ledger.md`.
- P8.7I website visual QA, accessibility, and public-post polish gate is recorded in
  `docs/architecture/phased-execution-completed-ledger.md`.
...
- [ ] GAR-FLOW-1C direct transient format/operator/result-sink expansion gate
  ...
  - Dependencies/blockers: source/format-specific parser support, result-sink evidence, and
    operator coverage.
- [ ] GAR-FLOW-2M prepared/native encoded operator or next source-state follow-through
  ...
  - Current state: prepared/native Vortex rows have process reuse, source metadata reuse,
    ...
    reuse, sort/top-N/window ranked-metric source-state reuse, source-backed scan evidence, and
    scoped residual-native fixture paths; generalized row-state reuse beyond these families and
    encoded/native operator coverage remain incomplete.
