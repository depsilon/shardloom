...
| GAR-COMPAT-1 | Universal compatibility completion matrix | RFC 0007, RFC 0008, RFC 0020, RFC 0028, RFC 0030, RFC 0031, RFC 0032, RFC 0033, RFC 0035, RFC 0036, RFC 0037 | Planned compatibility coverage lane and initial report-only scoreboard for CSV, JSONL/JSON, Parquet, Arrow IPC, Avro, ORC, Excel, SQLite, Postgres/MySQL, JDBC/ODBC, S3/GCS/ADLS, Iceberg/Delta/Hudi, Vortex, generated/source-free outputs, Python rows/DataFrame, SQL VALUES/literals, REST/Flight/ADBC, and Foundry; future slices must keep runtime-supported, smoke-supported, report-only, blocked, and not-planned rows distinct and cannot promote object-store, table/lakehouse, database/warehouse, SQL/DataFrame, Foundry, package, performance, or Spark-replacement claims without scoped evidence and no-fallback/no-external-engine proof. |
