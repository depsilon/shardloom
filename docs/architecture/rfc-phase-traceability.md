...
| RFC 0020 | Partially implemented | 12A, 13A, 13B | CG-9.1 schema-evolution, CG-9.2 partition-evolution, CG-9.3 delete/tombstone, CG-9.4 aggregate table compatibility, and CG-9.5 CDC incremental planning dependency evidence exist for typed transitions; broader catalog/table metadata integration, delete/tombstone execution, CDC execution, and layout/compaction intelligence remain planned. |
