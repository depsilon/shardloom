...
| RFC 0008 | Partially implemented | 11A, 14A, 14B | CG-10.1 object-store range planning and CG-10.2 request coalescing evidence exist for declared byte ranges; object-store IO, retry execution, distributed scheduling, and object-store commit behavior remain planned. |
