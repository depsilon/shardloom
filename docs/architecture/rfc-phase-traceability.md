...
| RFC 0008 | Partially implemented | 11A, 14A, 14B | CG-10.1 object-store range planning evidence exists for declared byte ranges; object-store IO, retry execution, distributed scheduling, and object-store commit behavior remain planned. |
