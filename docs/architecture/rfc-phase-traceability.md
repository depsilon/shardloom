...
| RFC 0020 | Partially implemented | 12A, 13A, 13B | CG-9.1 schema-evolution, CG-9.2 partition-evolution, and CG-9.3 delete/tombstone compatibility evidence exist for typed transitions; broader catalog/table metadata integration, delete/tombstone execution, and layout/compaction intelligence remain planned. |
