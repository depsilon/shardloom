...
| RFC 0025 | Planned | CG-1 through CG-23, Ongoing | Competitive Engine Track policy is documented; CG-21 is now the user data workflow and ETL surface, while CG-22 and CG-23 remain reserved placeholders pending incoming content-rich gate files; implementation remains gate-specific and evidence-gated. |
