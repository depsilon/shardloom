...
chunks without decode/materialization and blocks the provider on encoding-specific lowering for
`flag:fastlanes.bitpacked` and `value:vortex.sequence`. Broader
