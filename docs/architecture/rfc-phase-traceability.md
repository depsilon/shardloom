...
visible without inferring them from scattered fields. Broader incremental-state execution,
table/catalog/object-store partition-pruning, object-store multi-file, general source API runtime,
