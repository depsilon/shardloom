...
- `docs/architecture/phased-execution-plan.md` promotes CG-21A through CG-21R, CG-22A through CG-22I, and CG-23A through CG-23I into the Planned queue so future sessions can move items through Planned, Active, and Completed without maintaining a second current-status list.
