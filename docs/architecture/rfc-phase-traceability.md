...
| --- | --- | --- | --- | --- |
| PERF-01 through PERF-12; conditional PERF-13 | RFC 0044 Resident Runtime and Resource Ownership | RFC 0013 Streaming/Zero-Copy; RFC 0014 Memory/Spill; RFC 0015 Correctness; RFC 0017 Recovery; RFC 0021 Kernels; RFC 0031 Native I/O; RFC 0042 Vortex Runtime | Supplied performance overhaul, active PERF queue, provider boundaries, ownership and generation checks, complete-output measurements, explicit durable versus memory-visible publication | Maintainer-adopted 2026-09-05. Resident native count/projection, lifetime-bound buffer credits, bounded writer prefetch, and complete bounded JSON collect are partial implementation. The full packets remain open; see `performance-overhaul-implementation-2026-09-05.md`. No Python latency, general aggregate migration, global allocator coverage, spill runtime, or competitor claim follows from foundation tests. |
