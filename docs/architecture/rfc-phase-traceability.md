...
| RFC 0008 | Partially implemented | 11A, 14A, 14A.3, 14B | CG-10.1 object-store range planning, CG-10.2 request coalescing, and CG-10.3 commit protocol planning evidence exist for declared byte ranges and commit signals; object-store IO, retry execution, distributed scheduling, and object-store commit execution remain planned. |
