...
views that expose source-free generated-output posture. This is an alignment/report surface only:
it ties the `GeneratedSourceCertificate` contract and source-free API admission matrix to future
OpenLineage generated-source facets, OpenTelemetry result/evidence spans, Bayesian confidence refs,
and the Foundry generated-output boundary without emitting events, exporting telemetry, fitting a
confidence model, invoking Foundry, or writing object-store output.
