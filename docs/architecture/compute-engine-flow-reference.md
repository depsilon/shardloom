...
shapes over projection rows, aggregate output aliases, and group keys, scoped single-/multi-key
inner equi-joins, scoped computed projections and multi-key scalar top-N over joined rows, scoped
