...
4D/5G/F1 closeout note: current release-gated admitted semantics now include `matrix_row_count=64`
and `executable_fixture_count=54`, including scoped UTF-8 regex predicates, composed string functions, temporal arithmetic/
