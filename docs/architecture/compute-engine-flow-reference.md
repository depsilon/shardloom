...
multi-key group-by aggregate, aggregate aliases, single-key numeric `ORDER BY ... LIMIT ...` top-N shapes, and scoped
...
`.ndjson` files, including aggregate aliases. Adjacent formats, nested JSON/JSONPath,
