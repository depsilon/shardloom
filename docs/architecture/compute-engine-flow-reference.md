...
aggregate, and single-key numeric top-N shapes. Bounded `IN` predicates expose
`in_predicate_runtime_execution` and `in_list_value_count`; empty, NULL,
mixed DATE/non-DATE, oversized, and subquery-backed lists remain deterministic blockers.
