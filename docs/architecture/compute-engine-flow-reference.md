...
flat scalar binary sinks, including nullable/all-null binary rows when dtype/family evidence is
present; other NULL-bearing Vortex output batches block before writer conversion, and broad binary
sink fidelity remains blocked until separate replay evidence exists.
