...
query-builder write/fanout reports only when statement, source fingerprints, and output artifact
fingerprints still match; changed output artifacts invalidate reuse.
