...
`source_state_dirty_input_*` fields. All batch source-state paths emit
...
`source_state_group_category_metric_*`, `source_state_ranked_metric_*`, and
`source_state_selective_filter_*`, and `source_state_dirty_input_*` fields to show which scoped
