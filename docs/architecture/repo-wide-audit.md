...
Status: active audit body generated by `REPO-WIDE-AUDIT-1`; refreshed after PR #1174 and the
benchmark/website/performance follow-up queue promotion.
...
Checked-in coverage after the PR #1174/phase-plan refresh: 996 tracked files, 996 reviewed,
