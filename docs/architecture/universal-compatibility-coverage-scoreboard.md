...
| `sql_generate_series_range` | `smoke-supported` | `true` | `true` | Scoped `SELECT * FROM generate_series/range(...)` local JSONL/CSV fixture smoke only. |
