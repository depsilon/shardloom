...
| Generated / source-free outputs | Generated source | `report-only` | No first-class user-generated or engine-native generated-output runtime is supported yet. | GAR-GEN-1 and GAR-COMPAT-1B own GeneratedSourceCertificate planning. | No source Native I/O certificate is claimed when no source dataset is read; output evidence remains required. | Generated-source certificate, local output sink evidence, Python/SQL/DataFrame admission rows. | No generated-output runtime claim yet. |
