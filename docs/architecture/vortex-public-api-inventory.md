...
- Output payload plan CLI is `ShardLoom`-native in Phase 12C.3a and remains report-only. Output payload write APIs remain future Phase 12C / CG-3 work, and upstream `Vortex` write APIs remain deferred.
