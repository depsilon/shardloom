...
Status: selected local/source/package v1 release track with v0.2.1 GitHub pre-release, TestPyPI,
...
approval and channel proof now exist for the v0.2.1 GitHub pre-release, TestPyPI, PyPI, and
...
## v0.2.1 Publication Addendum

The source tree, public package channels, and checked-in channel proofs now point at v0.2.1 for the
...
| GitHub pre-release | Published v0.2.1 release assets with channel proof. | `docs/release/channel-proofs/github-prerelease-v0.2.1-transcript.json` |
| TestPyPI | Published v0.2.1 rehearsal package with Trusted Publisher proof. | `docs/release/channel-proofs/testpypi-v0.2.1-transcript.json` |
| PyPI | Published v0.2.1 public Python package with prior TestPyPI proof. | `docs/release/channel-proofs/pypi-v0.2.1-transcript.json` |
| Homebrew tap | Published v0.2.1 public CLI formula against the GitHub source archive. | `docs/release/channel-proofs/homebrew-v0.2.1-transcript.json` |

## Publication Sequence Completed For Selected Channels

The selected v0.2.1 channel order was:

1. Merge the v0.2.1 release-prep source revision.
2. Create the GitHub v0.2.1 release and attach source, wheel, sdist, CLI, checksums, SBOM, and
   provenance assets.
...
5. Publish PyPI through Trusted Publisher/OIDC and run the clean registry install/uninstall smoke
   transcript.
6. Publish the Homebrew tap formula against the immutable GitHub v0.2.1 source archive and run
   `brew install`, `shardloom status --format json`, and `brew uninstall` proof.

The completed publication proof records:

- release version and tag: `v0.2.1`
- selected channels: GitHub pre-release, TestPyPI, PyPI, Homebrew
- exact source revision: `19e9a3da28bede8bad59e5560b2d52875545cdab`
- release notes
...
```text
package_channel_status=published_v0.2.1_selected_channels
package_install_commands_visible=true
public_release_claim_allowed=false
public_package_claim_allowed=false
```

## v0.2.1 Tag Verification Result

The `v0.2.1` GitHub release uses a lightweight tag pointing at the GitHub-verified merge commit
`19e9a3da28bede8bad59e5560b2d52875545cdab`. Local GPG/SSH tag signing was unavailable during this
...
The selected GitHub, PyPI, and Homebrew channels expose the v0.2.1 package/CLI posture selected by
