...
| --- | --- | --- | --- | --- | --- |
| `CLICKBENCH-OLAP-RUNTIME-COVERAGE-1` | `required_for_v1` | `implementation_required` | `required_clickbench_olap_runtime_coverage_scope`; `docs/architecture/phased-execution-plan.md`; `benchmarks/clickbench/queries.sql`; `target/clickbench-olap-runtime-coverage.json` | `not_deferred` | dynamic; capillary; PulseWeave; metadata-first; timing-surface; evidence-tier |
| `PY-VORTEX-RESIDUAL-ROUTE-PROMOTION-1` | `required_for_v1` | `implementation_required` | `required_residual_native_vortex_route_and_export_scope`; `docs/architecture/phased-execution-plan.md`; `target/user-surface-runtime-gap-inventory.json` | `not_deferred` | dynamic; capillary; PulseWeave; metadata-first; timing-surface; evidence-tier |
...
| `PY-DATAFRAME-DETERMINISTIC-BLOCKER-COVERAGE-1` | `required_for_v1` | `implementation_required` | `required_dataframe_deterministic_blocker_coverage_scope`; `docs/architecture/phased-execution-plan.md`; `target/python-user-surface-completion-gate.json`; `target/user-surface-runtime-gap-inventory.json` | `not_deferred` | dynamic; capillary; PulseWeave; metadata-first; timing-surface; evidence-tier |
