...
| --- | --- | --- | --- | --- | --- |
| `PR-CODEX-COMMENT-RESOLUTION-1361-1363` | `required_for_v1` | `focused_validation_passed` | `required_recent_codex_review_finding_resolution`; `docs/architecture/phased-execution-plan.md`; `target/runtime-gap-family-burn-down.json`; `docs/benchmarks/clickbench-100m-uat-burndown.json` | `not_deferred` | dynamic; capillary; PulseWeave; metadata-first; timing-surface; evidence-tier |
| `GLOBAL-RUNTIME-GAP-CARRY-FORWARD-1` | `required_for_v1` | `active_governance_owner` | `required_active_owner_for_unchecked_global_runtime_gap_families`; `docs/architecture/phased-execution-plan.md`; `scripts/check_runtime_gap_family_burn_down.py`; `target/runtime-gap-family-burn-down.json` | `not_deferred` | dynamic; capillary; PulseWeave; metadata-first; timing-surface; evidence-tier |
...
| `CLICKBENCH-100M-PHYSICAL-POLICY-PLANNER-6` | `required_for_v1` | `implementation_in_progress` | `required_route_aware_native_vortex_physical_policy_planner`; `docs/architecture/phased-execution-plan.md`; `docs/benchmarks/clickbench-100m-uat-burndown.json` | `not_deferred` | dynamic; capillary; PulseWeave; metadata-first; timing-surface; evidence-tier |
| `CLICKBENCH-100M-SINGLE-ARTIFACT-LAYOUT-ADVISOR-9` | `required_for_v1` | `implementation_in_progress` | `required_single_artifact_vortex_layout_encoding_advisor`; `docs/architecture/phased-execution-plan.md`; `docs/benchmarks/clickbench-100m-uat-burndown.json` | `not_deferred` | dynamic; capillary; PulseWeave; metadata-first; timing-surface; evidence-tier |
| `CLICKBENCH-100M-HIGH-CARDINALITY-AGGREGATE-7` | `required_for_v1` | `implementation_in_progress` | `required_high_cardinality_exact_aggregate_state_redesign`; `docs/architecture/phased-execution-plan.md`; `docs/benchmarks/clickbench-100m-uat-burndown.json` | `not_deferred` | dynamic; capillary; PulseWeave; metadata-first; timing-surface; evidence-tier |
| `CLICKBENCH-100M-STRING-DOMAIN-PREDICATE-8` | `required_for_v1` | `implementation_in_progress` | `required_string_domain_predicate_dictionary_metadata_execution`; `docs/architecture/phased-execution-plan.md`; `docs/benchmarks/clickbench-100m-uat-burndown.json` | `not_deferred` | dynamic; capillary; PulseWeave; metadata-first; timing-surface; evidence-tier |
| `CLICKBENCH-100M-INGEST-WRITER-COALESCING-10` | `required_for_v1` | `implementation_in_progress` | `required_universal_ingest_writer_coalescing_and_timing_split`; `docs/architecture/phased-execution-plan.md`; `docs/benchmarks/clickbench-100m-uat-burndown.json` | `not_deferred` | dynamic; capillary; PulseWeave; metadata-first; timing-surface; evidence-tier |
| `CLICKBENCH-STRING-HEAVY-HITTER-EXACT-RECOUNT-11` | `required_for_v1` | `ship_drop_decision_required` | `required_string_heavy_hitter_exact_recount_optimization`; `docs/architecture/phased-execution-plan.md`; `docs/benchmarks/clickbench-100m-uat-burndown.json` | `not_deferred` | dynamic; capillary; PulseWeave; metadata-first; timing-surface; evidence-tier |
| `CLICKBENCH-TRANSFORM-CODE-MAP-12` | `required_for_v1` | `ship_drop_decision_required` | `required_transformed_dictionary_code_map_optimization`; `docs/architecture/phased-execution-plan.md`; `docs/benchmarks/clickbench-100m-uat-burndown.json` | `not_deferred` | dynamic; capillary; PulseWeave; metadata-first; timing-surface; evidence-tier |
| `CLICKBENCH-HIGH-CARDINALITY-RADIX-CAPILLARY-13` | `required_for_v1` | `ship_drop_decision_required` | `required_high_cardinality_radix_capillary_exact_state_optimization`; `docs/architecture/phased-execution-plan.md`; `docs/benchmarks/clickbench-100m-uat-burndown.json` | `not_deferred` | dynamic; capillary; PulseWeave; metadata-first; timing-surface; evidence-tier |
| `CLICKBENCH-ROW-REF-TOPK-SEGMENT-PRUNING-14` | `required_for_v1` | `ship_drop_decision_required` | `required_row_ref_topk_segment_pruning_optimization`; `docs/architecture/phased-execution-plan.md`; `docs/benchmarks/clickbench-100m-uat-burndown.json` | `not_deferred` | dynamic; capillary; PulseWeave; metadata-first; timing-surface; evidence-tier |
| `CLICKBENCH-INGEST-WRITER-SEGMENT-ECONOMICS-15` | `required_for_v1` | `ship_drop_decision_required` | `required_ingest_writer_segment_economics_optimization`; `docs/architecture/phased-execution-plan.md`; `docs/benchmarks/clickbench-100m-uat-burndown.json` | `not_deferred` | dynamic; capillary; PulseWeave; metadata-first; timing-surface; evidence-tier |
| `CLICKBENCH-ARTIFACT-SIZE-ENCODING-POLICY-16` | `required_for_v1` | `ship_drop_decision_required` | `required_single_artifact_size_encoding_policy_optimization`; `docs/architecture/phased-execution-plan.md`; `docs/benchmarks/clickbench-100m-uat-burndown.json` | `not_deferred` | dynamic; capillary; PulseWeave; metadata-first; timing-surface; evidence-tier |
| `CLICKBENCH-STRING-PREDICATE-MEMBERSHIP-17` | `required_for_v1` | `ship_drop_decision_required` | `required_string_predicate_membership_metadata_optimization`; `docs/architecture/phased-execution-plan.md`; `docs/benchmarks/clickbench-100m-uat-burndown.json`; `docs/architecture/clickbench-ingest-optimization-ledger.md` | `not_deferred` | dynamic; capillary; PulseWeave; metadata-first; timing-surface; evidence-tier |
| `VORTEX-075-NATIVE-PROVIDER-UTILIZATION-18` | `required_for_v1` | `provider_ship_drop_decision_required` | `required_vortex_075_native_provider_utilization_ship_drop`; `docs/architecture/phased-execution-plan.md`; `docs/skills/vortex/vortex-first-provider-check.md`; `docs/skills/vortex/vortex-versioning-upstream.md` | `not_deferred` | dynamic; capillary; PulseWeave; metadata-first; timing-surface; evidence-tier |
| `CLICKBENCH-AGGREGATE-PREDICATE-PUSHDOWN-19` | `required_for_v1` | `focused_validation_passed` | `required_clickbench_aggregate_predicate_pushdown_regression_fix`; `docs/architecture/phased-execution-plan.md`; `shardloom-vortex/src/local_primitives.rs`; `target/runtime-gap-family-burn-down.json` | `not_deferred` | dynamic; capillary; PulseWeave; metadata-first; timing-surface; evidence-tier |
