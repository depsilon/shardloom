...
| `PY-VORTEX-LOCAL-EXPORT-DISTINCT-CLOSEOUT-1` | `required_for_v1` | `implementation_required` | `required_local_export_distinct_closeout_scope`; `docs/architecture/phased-execution-plan.md`; `docs/architecture/v1-front-door-runtime-scope.md`; `docs/architecture/v1-vortex-runtime-scope.md`; `target/user-surface-runtime-gap-inventory.json` | `not_deferred` | dynamic; capillary; PulseWeave; metadata-first; timing-surface; evidence-tier |
