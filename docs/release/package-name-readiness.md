...
Status: v0.1.4 selected package identities are published and proof-backed for GitHub pre-release,
...
The v0.1.4 release sequence completed:

- GitHub release/tag/assets: `v0.1.4`
- TestPyPI package proof:
  `docs/release/channel-proofs/testpypi-v0.1.4-transcript.json`
- PyPI package proof:
  `docs/release/channel-proofs/pypi-v0.1.4-transcript.json`
- Homebrew tap proof:
...
python scripts\python_registry_package_proof.py --channel testpypi --version 0.1.4 --shardloom-bin target\release\shardloom --output target\python-registry-package-proof\testpypi-transcript.json
```
...
The current package-channel matrix is ready for the selected v0.1.4 channels and remains blocked for
