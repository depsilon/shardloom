...
Status: v0.2.1 selected package identities are published and proof-backed for GitHub pre-release,
...
The v0.2.1 release sequence completed:

- GitHub release/tag/assets: `v0.2.1`
- TestPyPI package proof:
  `docs/release/channel-proofs/testpypi-v0.2.1-transcript.json`
- PyPI package proof:
  `docs/release/channel-proofs/pypi-v0.2.1-transcript.json`
- Homebrew tap proof:
  `docs/release/channel-proofs/homebrew-v0.2.1-transcript.json`
...
python scripts\python_registry_package_proof.py --channel testpypi --version 0.2.1 --shardloom-bin target\release\shardloom --output target\python-registry-package-proof\testpypi-transcript.json
```
...
The current package-channel matrix is ready for the selected v0.2.1 channels and remains blocked for
