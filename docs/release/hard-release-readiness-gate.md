...
Do not run the hard release gate with `--allow-blocked` in CI or release-readiness evidence. Inspect
the emitted blocker report or the component gates when evidence is still incomplete.
