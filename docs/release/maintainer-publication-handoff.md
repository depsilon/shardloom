...
Status: release handoff packet after `RELEASE-PACKAGE-15`, amended through the proof-backed v0.1.10
...
- The selected v0.1.10 channels are published and proof-backed: GitHub pre-release assets,
...
- v0.1.10 is prepared as the next compatible post-v0.1.10 patch train for PR #1319 Codex review
  ...
  package-channel matrices or public install docs mark v0.1.10 published.
- Patch release notes live in `docs/release/v0.1.10-release-notes.md`.

- v0.1.10 is published and proof-backed through GitHub pre-release, TestPyPI, PyPI, and Homebrew.
...
Maintainer approval and proof are recorded for the v0.1.10 GitHub pre-release, TestPyPI, PyPI, and
...
- Current scoped full-local benchmark-publication evidence with public performance claims still
  disallowed.
- Selected v0.1.10 package-channel install proof for GitHub pre-release, TestPyPI, PyPI, and
  Homebrew.
...
- Package-channel readiness is no longer blocked for the selected v0.1.10 channels; GitHub
  pre-release, TestPyPI, PyPI, and Homebrew proofs are attached.
- Publication/API/schema stability: functional v1 surfaces are approved as stable for v0.1.10, but
...
| --- | --- | --- |
| GitHub pre-release | Published/proof-backed for v0.1.10 | Release/tag/assets/checksum/SBOM/provenance download proof: `docs/release/channel-proofs/github-prerelease-v0.1.10-transcript.json`. |
| TestPyPI | Published/proof-backed for v0.1.10 | Trusted Publisher upload and clean registry install/uninstall/smoke proof: `docs/release/channel-proofs/testpypi-v0.1.10-transcript.json`. |
| PyPI | Published/proof-backed for v0.1.10 | Trusted Publisher upload after TestPyPI proof and clean public install/uninstall/smoke proof: `docs/release/channel-proofs/pypi-v0.1.10-transcript.json`. |
| Homebrew tap | Published/proof-backed for v0.1.10 | Tap/formula audit/style/test plus source build install/uninstall/smoke proof: `docs/release/channel-proofs/homebrew-v0.1.10-transcript.json`. |
...
Publication approval for v0.1.10 is recorded in
...
Selected-channel package install claims are now allowed for v0.1.10. Production, performance,
