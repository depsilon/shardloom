...
| `diagnostic_row_id=public_package_publication` | Future package channels | Scoop, winget, conda-forge, GHCR, crates.io | `SL_UNSUPPORTED_PUBLIC_PACKAGE_PUBLICATION` | `release.package_publication_gate_required` | Selected v0.1.8 GitHub/TestPyPI/PyPI/Homebrew channels are published and proof-backed; future package channels, signing expansion, containers, feedstocks, and public Rust crates require separate approval and channel proof. |
