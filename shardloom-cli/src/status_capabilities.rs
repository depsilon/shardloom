...
const UNIVERSAL_COMPATIBILITY_ROWS: &[UniversalCompatibilityRow] = &[
    ...
    UniversalCompatibilityRow {
        ...
        generated_source_certificate_status: "scoped_local_jsonl_csv_structured_smoke",
        ...
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "local JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC fixture-smoke generated-output runtime only",
    },
    UniversalCompatibilityRow {
    ...
    UniversalCompatibilityRow {
        ...
        native_io_certificate_status: "local_output_certificate_required",
        generated_source_certificate_status: "scoped_local_jsonl_csv_structured_smoke",
        blocker_id: "none_scoped_local_sql_values_literals_jsonl_csv_structured_smoke_only",
        required_future_evidence: "broader_sql_parser_binder_planner_local_source_operator_evidence",
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "only source-free SQL VALUES/literal/range-generator local JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC fixture smokes are admitted; no broad SQL runtime claim",
    },
    UniversalCompatibilityRow {
        id: "rest_flight_adbc",
...
const GENERATED_OUTPUT_COMPATIBILITY_ROWS: &[GeneratedOutputCompatibilityRow] = &[
    ...
    GeneratedOutputCompatibilityRow {
        ...
        blocker_id: "none_scoped_local_jsonl_csv_structured_smoke_only",
        required_evidence: "generated_source_certificate,output_native_io_certificate,execution_certificate,no_fallback_evidence",
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "Only scoped local user-row JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC generated-output fixture smoke is admitted.",
    },
    GeneratedOutputCompatibilityRow {
        id: "python_ctx_range",
        ...
        output_native_io_certificate_status: "required_for_runtime_output",
        generated_source_certificate_status: "required_for_runtime",
        blocker_id: "none_scoped_local_range_jsonl_csv_structured_smoke_only",
        required_evidence: "generated_source_certificate,output_native_io_certificate,execution_certificate,no_fallback_evidence",
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "Only scoped local range JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC generated-output fixture smoke is admitted.",
    },
    GeneratedOutputCompatibilityRow {
        ...
        output_native_io_certificate_status: "required_for_runtime_output",
        generated_source_certificate_status: "required_for_runtime",
        blocker_id: "none_scoped_local_sequence_jsonl_csv_structured_smoke_only",
        required_evidence: "generated_source_certificate,output_native_io_certificate,execution_certificate,no_fallback_evidence",
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "Only scoped local sequence JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC generated-output fixture smoke is admitted.",
    },
    GeneratedOutputCompatibilityRow {
        ...
        output_native_io_certificate_status: "required_for_runtime_output",
        generated_source_certificate_status: "required_for_runtime",
        blocker_id: "none_scoped_local_literal_table_jsonl_csv_structured_smoke_only",
        ...
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "Only scoped local literal-table JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC generated-output fixture smoke is admitted.",
    },
    GeneratedOutputCompatibilityRow {
        ...
        output_native_io_certificate_status: "required_for_runtime_output",
        generated_source_certificate_status: "required_for_runtime",
        blocker_id: "none_scoped_local_calendar_jsonl_csv_structured_smoke_only",
        ...
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "Only scoped local calendar/date-dimension JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC generated-output fixture smoke is admitted.",
    },
    GeneratedOutputCompatibilityRow {
        ...
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "Generated-source write is admitted only for supported local user_rows, literal_table, calendar, range, sequence, SQL VALUES, SQL literal SELECT, and SQL generate_series/range JSONL/CSV plus feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC smokes.",
    },
    GeneratedOutputCompatibilityRow {
        ...
        claim_gate_status: "not_claim_grade",
        claim_boundary: "Generated output support is local JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC fixture-smoke only; object-store, lakehouse, and Foundry sinks remain blocked/report-only.",
    },
    GeneratedOutputCompatibilityRow {
        ...
        output_native_io_certificate_status: "required_for_runtime_output",
        generated_source_certificate_status: "required_for_runtime",
        blocker_id: "none_scoped_local_sql_literal_select_jsonl_csv_structured_smoke_only",
        ...
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "SQL literal SELECT is admitted only for scoped source-free local JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC generated-output fixture smokes; no broad SQL runtime claim.",
    },
    GeneratedOutputCompatibilityRow {
        id: "sql_values",
        ...
        output_native_io_certificate_status: "required_for_runtime_output",
        generated_source_certificate_status: "required_for_runtime",
        blocker_id: "none_scoped_local_sql_values_jsonl_csv_structured_smoke_only",
        ...
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "SQL VALUES is admitted only for scoped source-free local JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC generated-output fixture smokes; no broad SQL runtime claim.",
    },
    GeneratedOutputCompatibilityRow {
        ...
        output_native_io_certificate_status: "required_for_runtime_output",
        generated_source_certificate_status: "required_for_runtime",
        blocker_id: "none_scoped_local_sql_range_projection_jsonl_csv_structured_smoke_only",
    ...
    GeneratedOutputCompatibilityRow {
        ...
        output_native_io_certificate_status: "required_for_runtime_output",
        generated_source_certificate_status: "required_for_runtime",
        blocker_id: "none_scoped_local_generated_with_column_jsonl_csv_structured_smoke_only",
...
const SQL_FRONTEND_RUNTIME_LADDER_ROWS: &[SqlFrontendRuntimeLadderRow] = &[
    ...
    SqlFrontendRuntimeLadderRow {
        ...
        surface: "generated-source-sql-smoke",
        support_status: "smoke-supported",
        parser_executed: true,
        binder_executed: true,
        planner_executed: true,
        ...
        evidence_command_refs: "generated-source-sql-smoke,ShardLoomContext.sql_values,ShardLoomContext.sql_literal_select,ShardLoomContext.sql",
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "Scoped SQL VALUES/literal SELECT/generate_series/range generated-output runtime only; no broad SQL generator claim.",
    },
    SqlFrontendRuntimeLadderRow {
...
const RUNS_TODAY_SUPPORT_ROWS: &[RunsTodaySupportRow] = &[
    ...
    RunsTodaySupportRow {
        ...
        blocker_id: "none",
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "scoped local Vortex count/filter/project primitives are default-supported; scalar aggregate and materializing primitive families are admitted where the release build enables local Vortex primitive execution and emit explicit decode/materialization evidence; broader Vortex operator families require admitted native provider evidence",
        runtime_execution: true,
        data_read: true,
        write_io: false,
        fallback_attempted: false,
