...
const WORKFLOW_OPERATION_NAMES: &str = concat!(
    ...
    "count,query,having,with_column,group_by,agg,sort,limit,rename,drop,dropna,astype,",
    "sample,explode,",
    "merge,concat,pivot,pivot_table,melt,rolling,",
    "tail,describe,nunique,value_counts,fillna,isna,notna,duplicated,drop_duplicates,",
    "mask,replace,set_index,reset_index,sort_index,nlargest,nsmallest,fanout,",
...
const WORKFLOW_BLOCKER_IDS: &str = concat!(
    ...
    "cg21.workflow.count.runtime_not_admitted,",
    "cg21.workflow.query.predicate_not_admitted,",
    "cg21.workflow.having.predicate_not_admitted,",
    ...
    "cg21.workflow.astype.cast_semantics_contract_missing,",
    ...
    "cg21.workflow.write_avro.compatibility_export_unsupported,",
...
const UNSTRUCTURED_ADAPTER_CAPABILITY_ROWS: &[UnstructuredAdapterCapabilityRow] = &[
    ...
    UnstructuredAdapterCapabilityRow {
        id: "vortex_turboquant_vector_encoding",
        family: "vectors",
        surface: "Vortex TurboQuant vector encoding",
        support_status: "blocked",
        runtime_execution: false,
        source_io_performed: false,
        sink_io_performed: false,
        ...
        model_call_required: false,
        external_effect_blocker_id: "vector_search",
        blocker_id: "gar-0032-d.vortex_turboquant_vector_encoding_blocked",
        required_evidence: "vortex_turboquant_feature_probe,vector_dtype_contract,lossy_quantization_policy,decode_reconstruction_correctness,no_fallback_evidence",
        claim_boundary: "Vortex TurboQuant vector encoding is blocked; no vector quantization, ANN, similarity search, GPU, or quantized execution claim is added.",
    },
    UnstructuredAdapterCapabilityRow {
...
const ETL_WORKFLOW_ROW_ORDER: &str = concat!(
    ...
    "prepared_native_vortex_batch_smoke,source_free_user_rows_jsonl_csv,source_free_range_jsonl_csv,",
    "source_free_literal_table_jsonl_csv,source_free_calendar_jsonl_csv,",
...
const COMPUTE_EXECUTION_MODE_VOCABULARY: &str =
...
const SQL_FRONTEND_RUNTIME_LADDER_SCHEMA_VERSION: &str = "shardloom.sql_frontend_runtime_ladder.v1";
const SQL_FRONTEND_RUNTIME_LADDER_ID: &str = "gar-runtime-impl-5b.sql_frontend_runtime_ladder";
...
#[derive(Debug, Clone, Copy)]
#[allow(clippy::struct_excessive_bools)]
struct SqlFrontendRuntimeLadderRow {
    id: &'static str,
    syntax_family: &'static str,
    surface: &'static str,
    support_status: &'static str,
    parser_executed: bool,
    binder_executed: bool,
    planner_executed: bool,
    runtime_execution: bool,
    dataframe_runtime: bool,
    source_io_performed: bool,
    output_io_performed: bool,
    ...
    required_evidence: &'static str,
    evidence_command_refs: &'static str,
    claim_gate_status: &'static str,
    claim_boundary: &'static str,
}
...
const UNIVERSAL_COMPATIBILITY_ROWS: &[UniversalCompatibilityRow] = &[
    UniversalCompatibilityRow {
        ...
        native_io_certificate_status: "local_source_state_vortex_ingest_certificate",
        generated_source_certificate_status: "not_applicable",
        blocker_id: "none_local_csv_adapter_read_runtime_supported",
        required_future_evidence: "native_vortex_derived_csv_export_contract,object_store_table_production_claim_evidence",
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "local CSV SourceState and vortex_ingest normalization for admitted flat schemas only; internal local-source smoke and decoded CSV output are internal-only and not public workflow routes; no object-store/table or production claim",
    },
    UniversalCompatibilityRow {
        id: "jsonl_ndjson",
        surface: "JSONL / NDJSON",
        family: "local_compatibility_file",
        direction: "read",
        support_status: "runtime-supported",
        runtime_supported: true,
        ...
        native_io_certificate_status: "local_source_state_vortex_ingest_certificate",
        generated_source_certificate_status: "not_applicable",
        blocker_id: "none_local_jsonl_adapter_read_runtime_supported",
        required_future_evidence: "native_vortex_derived_jsonl_export_contract,nested_json_jsonpath_object_store_table_production_evidence",
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "local flat JSONL/NDJSON SourceState and vortex_ingest normalization only; internal local-source smoke and decoded JSONL output are internal-only and not public workflow routes; no nested JSON, JSONPath, object-store/table, or production claim",
    },
    UniversalCompatibilityRow {
        id: "json",
        surface: "JSON",
        ...
        source_io_performed: true,
        output_io_performed: false,
        native_io_certificate_status: "local_source_state_and_vortex_ingest_certificate",
        generated_source_certificate_status: "not_applicable",
        blocker_id: "none_local_json_adapter_runtime_supported",
        required_future_evidence: "nested_json_jsonpath_json_output_object_store_table_production_evidence",
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "local flat top-level JSON object/array SourceState and vortex_ingest runtime only; no nested JSON, JSONPath, JSON sink, object-store/table, or production claim",
    },
    UniversalCompatibilityRow {
        id: "parquet",
        surface: "Parquet",
        ...
        source_io_performed: true,
        output_io_performed: false,
        native_io_certificate_status: "local_columnar_source_state_vortex_ingest_certificate",
        generated_source_certificate_status: "not_applicable",
    ...
    UniversalCompatibilityRow {
        ...
        native_io_certificate_status: "local_columnar_source_state_vortex_ingest_certificate",
        generated_source_certificate_status: "not_applicable",
        blocker_id: "none_feature_gated_local_avro_adapter_read_runtime_supported",
        required_future_evidence: "native_vortex_derived_avro_export_contract,schema_evolution_logical_type_object_store_table_production_evidence",
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "feature-gated flat scalar local Avro SourceState and vortex_ingest normalization only; decoded Avro output is a separate compatibility export contract and not a public workflow route; no schema-evolution, logical-type completeness, or production claim",
    },
    UniversalCompatibilityRow {
        id: "orc",
        surface: "ORC",
        ...
        native_io_certificate_status: "local_columnar_source_state_vortex_ingest_certificate",
        generated_source_certificate_status: "not_applicable",
        blocker_id: "none_feature_gated_local_orc_adapter_read_runtime_supported",
        required_future_evidence: "native_vortex_derived_orc_export_contract,stripe_statistics_nested_type_object_store_table_production_evidence",
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "feature-gated flat scalar local ORC SourceState and vortex_ingest normalization only; decoded ORC output is a separate compatibility export contract and not a public workflow route; no stripe/statistics runtime or production claim",
    },
    UniversalCompatibilityRow {
        id: "excel",
        surface: "Excel",
    ...
    UniversalCompatibilityRow {
        ...
        generated_source_certificate_status: "scoped_local_jsonl_csv_structured_runtime",
        blocker_id: "gar-compat-1b.generated_output_broader_api_evidence_missing",
        required_future_evidence: "vortex_output_sequence_values_literal_table_calendar_sql_dataframe_object_store_foundry_output_evidence",
        claim_gate_status: "not_claim_grade",
        claim_boundary: "local JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC generated-output runtime only",
    },
    UniversalCompatibilityRow {
        ...
        claim_gate_status: "not_claim_grade",
        claim_boundary: "generated local-output runtime only; no broad DataFrame runtime claim",
    },
    UniversalCompatibilityRow {
        ...
        native_io_certificate_status: "local_output_certificate_required",
        generated_source_certificate_status: "scoped_local_jsonl_csv_structured_runtime",
        blocker_id: "none_scoped_local_sql_values_literals_jsonl_csv_structured_runtime",
        required_future_evidence: "broader_sql_parser_binder_planner_local_source_operator_evidence",
        claim_gate_status: "not_claim_grade",
        claim_boundary: "only source-free SQL VALUES/literal/range-generator local JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC generated-output runtime is admitted; no broad SQL runtime claim",
    },
    UniversalCompatibilityRow {
        id: "rest_flight_adbc",
...
const GENERATED_OUTPUT_COMPATIBILITY_ROWS: &[GeneratedOutputCompatibilityRow] = &[
    ...
    GeneratedOutputCompatibilityRow {
        ...
        user_visible_surface: "Python ctx.from_rows([...]).write(local_jsonl_csv_or_feature_gated_structured)",
        ...
        blocker_id: "none_scoped_local_jsonl_csv_structured_runtime",
        required_evidence: "generated_source_certificate,output_native_io_certificate,execution_certificate,no_fallback_evidence",
        claim_gate_status: "not_claim_grade",
        claim_boundary: "Only scoped local user-row JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC generated-output runtime is admitted.",
    },
    GeneratedOutputCompatibilityRow {
        id: "python_ctx_range",
        user_visible_surface: "Python ctx.range(...).write(local_jsonl_csv_or_feature_gated_structured)",
        family: "python_generated_source",
        support_status: "runtime-supported",
        runtime_execution: true,
        data_read: false,
        ...
        output_native_io_certificate_status: "required_for_runtime_output",
        generated_source_certificate_status: "required_for_runtime",
        blocker_id: "none_scoped_local_range_jsonl_csv_structured_runtime",
        required_evidence: "generated_source_certificate,output_native_io_certificate,execution_certificate,no_fallback_evidence",
        claim_gate_status: "not_claim_grade",
        claim_boundary: "Only scoped local range JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC generated-output runtime is admitted.",
    },
    GeneratedOutputCompatibilityRow {
        id: "python_ctx_sequence",
        user_visible_surface: "Python ctx.sequence(...).write(local_jsonl_csv_or_feature_gated_structured)",
        family: "python_generated_source",
        support_status: "runtime-supported",
        runtime_execution: true,
        data_read: false,
        ...
        output_native_io_certificate_status: "required_for_runtime_output",
        generated_source_certificate_status: "required_for_runtime",
        blocker_id: "none_scoped_local_sequence_jsonl_csv_structured_runtime",
        required_evidence: "generated_source_certificate,output_native_io_certificate,execution_certificate,no_fallback_evidence",
        claim_gate_status: "not_claim_grade",
        claim_boundary: "Only scoped local sequence JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC generated-output runtime is admitted.",
    },
    GeneratedOutputCompatibilityRow {
        id: "python_ctx_literal_table",
        user_visible_surface: "Python ctx.literal_table([...]).write(local_jsonl_csv_or_feature_gated_structured)",
        family: "python_generated_source",
        support_status: "runtime-supported",
        runtime_execution: true,
        data_read: false,
        ...
        output_native_io_certificate_status: "required_for_runtime_output",
        generated_source_certificate_status: "required_for_runtime",
        blocker_id: "none_scoped_local_literal_table_jsonl_csv_structured_runtime",
        ...
        claim_gate_status: "not_claim_grade",
        claim_boundary: "Only scoped local literal-table JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC generated-output runtime is admitted.",
    },
    GeneratedOutputCompatibilityRow {
        id: "python_ctx_calendar",
        user_visible_surface: "Python ctx.calendar(start,end).write(local_jsonl_csv_or_feature_gated_structured)",
        family: "python_generated_source",
        support_status: "runtime-supported",
        runtime_execution: true,
        data_read: false,
        ...
        output_native_io_certificate_status: "required_for_runtime_output",
        generated_source_certificate_status: "required_for_runtime",
        blocker_id: "none_scoped_local_calendar_jsonl_csv_structured_runtime",
        ...
        claim_gate_status: "not_claim_grade",
        claim_boundary: "Only scoped local calendar/date-dimension JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC generated-output runtime is admitted.",
    },
    GeneratedOutputCompatibilityRow {
        id: "python_generated_source_write",
        user_visible_surface: "Python GeneratedRowsSource/GeneratedRangeSource/GeneratedSqlSource.write(local_jsonl_csv_or_feature_gated_structured)",
        family: "python_generated_source",
        support_status: "runtime-supported",
        runtime_execution: true,
        data_read: false,
        ...
        output_native_io_certificate_status: "required_for_runtime_output",
        generated_source_certificate_status: "required_for_runtime",
        blocker_id: "none_supported_generated_source_write_runtime",
        ...
        claim_gate_status: "not_claim_grade",
        claim_boundary: "Generated-source write is admitted only for supported local user_rows, literal_table, calendar, range, sequence, SQL VALUES, SQL literal SELECT, and SQL generate_series/range JSONL/CSV plus feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC runtime.",
    },
    GeneratedOutputCompatibilityRow {
        ...
        claim_gate_status: "not_claim_grade",
        claim_boundary: "Generated output support is local JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC runtime only; object-store, lakehouse, and Foundry sinks remain blocked/report-only.",
    },
    GeneratedOutputCompatibilityRow {
        ...
        output_native_io_certificate_status: "required_for_runtime_output",
        generated_source_certificate_status: "required_for_runtime",
        blocker_id: "none_scoped_local_sql_literal_select_jsonl_csv_structured_runtime",
        ...
        claim_gate_status: "not_claim_grade",
        claim_boundary: "SQL literal SELECT is admitted only for scoped source-free local JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC generated-output runtime; no broad SQL runtime claim.",
    },
    GeneratedOutputCompatibilityRow {
        id: "sql_values",
        ...
        output_native_io_certificate_status: "required_for_runtime_output",
        generated_source_certificate_status: "required_for_runtime",
        blocker_id: "none_scoped_local_sql_values_jsonl_csv_structured_runtime",
        ...
        claim_gate_status: "not_claim_grade",
        claim_boundary: "SQL VALUES is admitted only for scoped source-free local JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC generated-output runtime; no broad SQL runtime claim.",
    },
    GeneratedOutputCompatibilityRow {
        ...
        output_native_io_certificate_status: "required_for_runtime_output",
        generated_source_certificate_status: "required_for_runtime",
        blocker_id: "none_scoped_local_sql_range_projection_jsonl_csv_structured_runtime",
        ...
        claim_gate_status: "not_claim_grade",
        claim_boundary: "SQL source-free projection is admitted only for scoped range-generator value-column/int64 expression projections to local JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC sinks; arbitrary SQL source-free projection remains blocked.",
    },
    GeneratedOutputCompatibilityRow {
        ...
        output_native_io_certificate_status: "required_for_runtime_output",
        generated_source_certificate_status: "required_for_runtime",
        blocker_id: "none_scoped_local_sql_generate_series_range_jsonl_csv_structured_runtime",
        ...
        claim_gate_status: "not_claim_grade",
        claim_boundary: "SQL generate_series/range is admitted only for SELECT * plus scoped value-column/int64-arithmetic projections from generate_series/range(...) local JSONL/CSV and feature-gated flat scalar Parquet/Arrow IPC/Avro/ORC generated-output runtime; no broad SQL runtime claim.",
    },
    GeneratedOutputCompatibilityRow {
        ...
        output_native_io_certificate_status: "required_for_runtime_output",
        generated_source_certificate_status: "required_for_runtime",
        blocker_id: "none_scoped_local_dataframe_literal_projection_jsonl_csv_structured_runtime",
    ...
    GeneratedOutputCompatibilityRow {
        ...
        output_native_io_certificate_status: "required_for_runtime_output",
        generated_source_certificate_status: "required_for_runtime",
        blocker_id: "none_scoped_local_generated_with_column_jsonl_csv_structured_runtime",
...
const SQL_FRONTEND_RUNTIME_LADDER_ROWS: &[SqlFrontendRuntimeLadderRow] = &[
    ...
    SqlFrontendRuntimeLadderRow {
        ...
        deterministic_diagnostics: true,
        blocker_id: "none_admitted_local_source_output_fanout",
        unsupported_diagnostic_code: "none",
    ...
    SqlFrontendRuntimeLadderRow {
        ...
        syntax_family: "source_free_generated_output",
        surface: "generated-source-sql",
        ...
        materialization_required: false,
        deterministic_diagnostics: true,
        blocker_id: "none_scoped_source_free_sql_generated_output",
        unsupported_diagnostic_code: "none",
        required_evidence: "generated_source_certificate,output_native_io_certificate,source_free_sql_fields,no_fallback_evidence",
        evidence_command_refs: "generated-source-sql,ShardLoomContext.sql_values,ShardLoomContext.sql_literal_select,ShardLoomContext.sql",
        claim_gate_status: "not_claim_grade",
        claim_boundary: "Source-free SQL VALUES/literal SELECT/generate_series/range generated-output runtime only; no broad SQL generator claim.",
    },
    SqlFrontendRuntimeLadderRow {
        id: "broad_sql_parse_bind_plan_execute",
        syntax_family: "broad_sql_frontend",
        surface: "workflow-unsupported-plan",
        support_status: "blocked",
        ...
        evidence_command_refs: "workflow-unsupported-plan sql-parse,workflow-unsupported-plan sql-bind,workflow-unsupported-plan sql-plan,workflow-unsupported-plan sql-execute",
        claim_gate_status: "not_claim_grade",
        claim_boundary: "Broad SQL parse/bind/plan/execute remains blocked outside admitted local-source and source-free fixture shapes.",
    },
    SqlFrontendRuntimeLadderRow {
        id: "catalog_cte_setop_recursive_sql",
        syntax_family: "catalog_cte_setop_recursive",
        surface: "workflow-unsupported-plan",
        support_status: "blocked",
        parser_executed: false,
        binder_executed: false,
    ...
    SqlFrontendRuntimeLadderRow {
        ...
        syntax_family: "correlated_broad_subquery",
        surface: "workflow-unsupported-plan",
        support_status: "blocked",
        parser_executed: false,
        binder_executed: false,
    ...
    SqlFrontendRuntimeLadderRow {
        ...
        syntax_family: "object_store_table_sql",
        surface: "workflow-unsupported-plan",
        support_status: "blocked",
        parser_executed: false,
        binder_executed: false,
    ...
    SqlFrontendRuntimeLadderRow {
        id: "fallback_engine_sql",
        syntax_family: "fallback_engine",
        surface: "workflow-unsupported-plan",
        support_status: "blocked",
        parser_executed: false,
        binder_executed: false,
        ...
        unsupported_diagnostic_code: "SL_NO_FALLBACK_EXECUTION",
        required_evidence: "no_fallback_policy,execution_certificate,native_operator_coverage",
        evidence_command_refs: "workflow-unsupported-plan fallback-engine,capabilities sql",
        claim_gate_status: "not_claim_grade",
        claim_boundary: "Spark, DataFusion, DuckDB, SQLite, Polars, pandas, or other engines cannot execute unsupported SQL as fallback.",
    },
];
...
const NATIVE_UNSUPPORTED_COVERAGE_ROWS: &[NativeUnsupportedCoverageRow] = &[
    ...
    NativeUnsupportedCoverageRow {
        ...
        category: "operator",
        surface: "broad_scalar_expression_registry_claim",
        support_status: "unsupported",
        unsupported_diagnostic_code: "SL_UNSUPPORTED_BROAD_NATIVE_SCALAR_EXPRESSION_REGISTRY",
        blocker_id: "gar0002.native.operator.broad_scalar_expression_registry",
        required_future_evidence: "arbitrary_scalar_expression_registry,semantic_fixtures,execution_certificate",
    ...
    NativeUnsupportedCoverageRow {
        ...
        category: "workload",
        surface: "broad_sql_dataframe_frontend_claim",
        support_status: "unsupported",
        unsupported_diagnostic_code: "SL_UNSUPPORTED_BROAD_SQL_DATAFRAME_RUNTIME",
        blocker_id: "cg21.workflow.broad_sql_dataframe_frontend_unsupported",
        required_future_evidence: "broad_sql_parser,binder,planner,dataframe_api_semantics",
...
fn emit_workflow_capability_parity(scope: CapabilityDiscoveryScope, format: OutputFormat) {
    ...
    push_count_field(
        ...
        WORKFLOW_OPERATION_NAMES.split(',').count(),
    );
    push_field(
        &mut fields,
...
fn compute_capability_matrix_fields() -> Vec<(String, String)> {
    ...
    push_bool_field(
        &mut fields,
        "internal_source_smoke_unsupported_parity_present",
        true,
    );
...
const RUNS_TODAY_SUPPORT_ROWS: &[RunsTodaySupportRow] = &[
    ...
    RunsTodaySupportRow {
        id: "cli_generated_source_runtime",
        family: "cli_command",
        surface: "generated-source-user-rows,generated-source-range,generated-source-sequence,generated-source-sql",
        support_state: "executable",
        feature_gate: "default",
        evidence_refs: "generated_source_runtime_tests,generated_source_certificate_contract",
        blocker_id: "none",
        claim_gate_status: "not_claim_grade",
        claim_boundary: "source-free/generated local output runtime only; not a broad SQL generator, external platform sink, or performance claim",
        runtime_execution: true,
        data_read: false,
        write_io: true,
        fallback_attempted: false,
    ...
    RunsTodaySupportRow {
        ...
        family: "python_api",
        surface: "ctx.read,read_csv,read_json,read_parquet,read_arrow_ipc,read_avro,read_orc,sql,LazyFrame.collect/profile/write_vortex/write_jsonl/write_csv/fanout local-file vortex-middle route",
        support_state: "feature_gated",
    ...
    RunsTodaySupportRow {
        ...
        family: "python_api",
        surface: "read_vortex,LazyFrame.collect native Vortex primitives plus feature-gated materializing primitives",
        support_state: "executable",
        feature_gate: "default",
        evidence_refs: "python.tests.test_query_builder,vortex_count_tests,vortex_filter_project_tests,simple_aggregate_vortex_tests",
        blocker_id: "none",
        claim_gate_status: "not_claim_grade",
        claim_boundary: "Local Vortex count/filter/project primitives are default-supported; scalar aggregate and materializing primitive families are admitted where the release build enables local Vortex primitive execution and emit explicit decode/materialization evidence; broader Vortex operator families require admitted native provider evidence",
        runtime_execution: true,
        data_read: true,
        write_io: false,
        fallback_attempted: false,
    ...
    RunsTodaySupportRow {
        ...
        support_state: "executable",
        feature_gate: "default",
        evidence_refs: "local_source_runtime,vortex_prepare_text_adapter_tests,traditional_internal_source_smoke_tests,python_query_builder_tests,universal_ingress_route_taxonomy",
        blocker_id: "none",
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "flat local text SourceState, internal internal-source-smoke smoke, and vortex_ingest fixture coverage only; public Python/DataFrame runtime requires Vortex preparation or native Vortex input",
        runtime_execution: true,
        data_read: true,
        write_io: false,
        fallback_attempted: false,
    ...
    RunsTodaySupportRow {
        ...
        claim_gate_status: "not_claim_grade",
        claim_boundary: "local flat-scalar feature-gated SourceState, internal internal-source-smoke smoke, and vortex_ingest adapters only; public Python/DataFrame runtime requires Vortex preparation or native Vortex input",
        runtime_execution: true,
        data_read: true,
        write_io: false,
        fallback_attempted: false,
    ...
    RunsTodaySupportRow {
        ...
        support_state: "executable",
        feature_gate: "release-user-surfaces for public Vortex-derived local workflow exports and generated-source local-output runtime",
        ...
        blocker_id: "none",
        claim_gate_status: "not_claim_grade",
        claim_boundary: "public local-source JSONL/CSV writes and JSONL+CSV fanout are admitted only when derived from native/prepared Vortex primitive row streams or exact provider-backed native Vortex result summaries with explicit decode/materialization evidence; generated-source local output is a separate generated-source runtime surface, while internal fixture result output remains smoke-only",
        runtime_execution: true,
        data_read: false,
        write_io: true,
        fallback_attempted: false,
    ...
    RunsTodaySupportRow {
        ...
        blocker_id: "feature.vortex_write_required_for_default_build",
        claim_gate_status: "not_claim_grade",
        claim_boundary: "Local Vortex artifact writes are admitted when the Vortex writer feature is enabled; no object-store/table commit or production claim",
        runtime_execution: true,
        data_read: false,
        write_io: true,
        fallback_attempted: false,
    ...
    RunsTodaySupportRow {
        id: "execution_distributed_local_fixture",
        family: "execution_mode",
        surface: "distributed-local-fixture-run,local coordinator,local workers,split fragments,deterministic merge",
        support_state: "executable",
        feature_gate: "default",
        evidence_refs: "distributed-local-fixture-run 2 fault-injection,shardloom.local_distributed_fixture_run.v1,shardloom.local_distributed_split_manifest.v1",
        blocker_id: "prod-ready-1d.remote_worker_remote_shuffle_spill_benchmark_blocked",
        claim_gate_status: "not_claim_grade",
        claim_boundary: "scoped in-process local distributed fixture with local hash repartition/local combine/global merge only; no remote worker, object-store, remote shuffle, spill IO, production, performance, or Spark-displacement claim",
        runtime_execution: true,
        data_read: false,
        write_io: false,
        fallback_attempted: false,
    ...
    RunsTodaySupportRow {
        id: "execution_live_hybrid_local_checkpoint_fixture",
        family: "execution_mode",
        surface: "live-hybrid-durable-checkpoint-smoke,local checkpoint JSON,local changelog JSONL,local state-store JSON,Vortex microsegment manifest,cold-promotion manifest,partial-checkpoint cleanup,idempotent replay evidence,restore digest",
        support_state: "executable",
        feature_gate: "default",
        evidence_refs: "live-hybrid-durable-checkpoint-smoke <checkpoint-dir>,shardloom.live_hybrid_durable_checkpoint_fixture.v1,cg22.live_hybrid.fixture.durable_checkpoint.native_io,shardloom.live_hybrid_vortex_micro_segment_manifest.v1,shardloom.live_hybrid_cold_vortex_segment_promotion_manifest.v1,shardloom.live_hybrid_partial_checkpoint_recovery.v1",
        blocker_id: "prod-ready-1e.production_state_store_broker_object_store_exactly_once_blocked",
        claim_gate_status: "not_claim_grade",
        claim_boundary: "scoped local filesystem checkpoint/changelog/state-store plus Vortex microsegment and cold-promotion manifest fixture only; no broker, object-store checkpoint, upstream Vortex file write, exactly-once, public production streaming, performance, or Spark-displacement claim",
        runtime_execution: true,
        data_read: false,
        write_io: true,
        fallback_attempted: false,
...
const PRODUCTION_UNSUPPORTED_DIAGNOSTIC_ROWS: &[ProductionUnsupportedDiagnosticRow] = &[
    ProductionUnsupportedDiagnosticRow {
        ...
        blocker_id: "cg21.workflow.sql.frontend_unsupported",
        message: "Broad production SQL/DataFrame execution is not admitted; scoped local Python/SQL/DataFrame workflows must use Vortex preparation/native input and deterministic route evidence.",
        next_action: "Use ctx.read(...), ctx.sql(...), route/run, capabilities sql,dataframe, and workflow-unsupported-plan to inspect supported local Vortex-prepared/native shapes before requesting broader execution.",
...
fn sql_frontend_runtime_ladder_row_order() -> String {
    SQL_FRONTEND_RUNTIME_LADDER_ROWS
        .iter()
        .map(|row| row.id)
        .collect::<Vec<_>>()
        .join(",")
...
fn sql_frontend_runtime_ladder_runtime_row_order() -> String {
    SQL_FRONTEND_RUNTIME_LADDER_ROWS
        .iter()
        .filter(|row| row.runtime_execution)
        .map(|row| row.id)
        .collect::<Vec<_>>()
        .join(",")
}

fn sql_frontend_runtime_ladder_blocked_row_order() -> String {
    SQL_FRONTEND_RUNTIME_LADDER_ROWS
        .iter()
...
fn sql_frontend_runtime_ladder_status_count(status: &str) -> usize {
    SQL_FRONTEND_RUNTIME_LADDER_ROWS
        .iter()
        .filter(|row| row.support_status == status)
        .count()
...
fn sql_frontend_runtime_ladder_blocker_ids() -> String {
    SQL_FRONTEND_RUNTIME_LADDER_ROWS
        .iter()
        .filter(|row| !row.blocker_id.starts_with("none"))
        .map(|row| row.blocker_id)
        .collect::<Vec<_>>()
        .join(",")
}

fn sql_frontend_runtime_ladder_required_evidence() -> String {
    SQL_FRONTEND_RUNTIME_LADDER_ROWS
        .iter()
...
fn append_sql_frontend_runtime_ladder_fields(fields: &mut Vec<(String, String)>) {
    append_sql_frontend_runtime_ladder_summary_fields(fields);
    append_sql_frontend_runtime_ladder_runtime_fields(fields);
    append_sql_frontend_runtime_ladder_claim_fields(fields);

    for row in SQL_FRONTEND_RUNTIME_LADDER_ROWS {
        append_sql_frontend_runtime_ladder_row_fields(fields, row);
    }
}

fn append_sql_frontend_runtime_ladder_summary_fields(fields: &mut Vec<(String, String)>) {
    push_field(
        fields,
    ...
    push_field(
        ...
        &sql_frontend_runtime_ladder_runtime_row_order(),
    );
    push_field(
        fields,
        "sql_frontend_runtime_ladder_blocked_family_order",
        &sql_frontend_runtime_ladder_blocked_row_order(),
    );
    push_count_field(
        fields,
        "sql_frontend_runtime_ladder_smoke_supported_count",
        sql_frontend_runtime_ladder_status_count("smoke-supported"),
    );
    push_count_field(
        fields,
        "sql_frontend_runtime_ladder_blocked_count",
        sql_frontend_runtime_ladder_status_count("blocked"),
    );
    push_field(
        fields,
...
fn append_sql_frontend_runtime_ladder_runtime_fields(fields: &mut Vec<(String, String)>) {
    push_bool_field(fields, "sql_frontend_runtime_ladder_parser_executed", true);
    push_bool_field(fields, "sql_frontend_runtime_ladder_binder_executed", true);
    push_bool_field(fields, "sql_frontend_runtime_ladder_planner_executed", true);
    push_bool_field(
        fields,
    ...
    push_bool_field(
        ...
        SQL_FRONTEND_RUNTIME_LADDER_ROWS
            .iter()
            .all(|row| row.deterministic_diagnostics),
    );
    push_bool_field(
        fields,
...
fn append_sql_frontend_runtime_ladder_claim_fields(fields: &mut Vec<(String, String)>) {
    push_bool_field(
        fields,
    ...
    push_field(
        ...
        "Scoped local-source and source-free SQL fixture-smoke runtime families are admitted with deterministic blockers for broad SQL; no production, broad SQL/DataFrame, object-store/table, external-engine, fallback, performance, or Spark-replacement claim.",
    );
}

fn append_sql_frontend_runtime_ladder_row_fields(
    fields: &mut Vec<(String, String)>,
    row: &SqlFrontendRuntimeLadderRow,
) {
    let prefix = format!("sql_frontend_runtime_ladder_row_{}", row.id);
    push_field(
        fields,
        &format!("{prefix}_syntax_family"),
        row.syntax_family,
    );
    push_field(fields, &format!("{prefix}_surface"), row.surface);
    push_field(
    ...
    push_bool_field(
        fields,
        &format!("{prefix}_parser_executed"),
        row.parser_executed,
    );
    push_bool_field(
        fields,
        &format!("{prefix}_binder_executed"),
        row.binder_executed,
    );
    push_bool_field(
        fields,
        &format!("{prefix}_planner_executed"),
    ...
    push_bool_field(
        fields,
        &format!("{prefix}_dataframe_runtime"),
        row.dataframe_runtime,
    );
    push_bool_field(
        fields,
    ...
    push_bool_field(
        fields,
        &format!("{prefix}_materialization_required"),
        row.materialization_required,
    );
    push_bool_field(
        fields,
        &format!("{prefix}_deterministic_diagnostics"),
        row.deterministic_diagnostics,
    );
    append_sql_frontend_runtime_ladder_row_text_fields(fields, &prefix, row);
    push_bool_field(fields, &format!("{prefix}_fallback_attempted"), false);
    push_bool_field(fields, &format!("{prefix}_external_engine_invoked"), false);
}

fn append_sql_frontend_runtime_ladder_row_text_fields(
    fields: &mut Vec<(String, String)>,
    prefix: &str,
    row: &SqlFrontendRuntimeLadderRow,
) {
    ...
    push_field(
        fields,
        &format!("{prefix}_evidence_command_refs"),
        row.evidence_command_refs,
    );
    push_field(
        fields,
        &format!("{prefix}_claim_gate_status"),
...
fn append_local_vortex_primitive_execution_discovery_fields(fields: &mut Vec<(String, String)>) {
    ...
    push_field(
        ...
        "count_all,count_where,filter_predicate,project_columns,filter_and_project,distinct,drop_duplicates,duplicate_mask,tail,sample,expression_project,melt,explode,pivot,rolling_window,aggregate,sort_rows",
    );
    push_field(
        fields,
    ...
    push_field(
        ...
        "distinct,drop_duplicates,duplicate_mask,tail,sample,expression_project,melt,explode,pivot,rolling_window,aggregate,sort_rows",
    );
