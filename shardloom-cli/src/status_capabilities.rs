...
const UNIVERSAL_COMPATIBILITY_ROWS: &[UniversalCompatibilityRow] = &[
    UniversalCompatibilityRow {
        ...
        native_io_certificate_status: "scoped_compatibility_import_and_local_output_certificate",
        ...
        claim_boundary: "scoped local CSV source and sink smoke only; no production CSV runtime claim",
    },
    UniversalCompatibilityRow {
        id: "jsonl_json",
        ...
        source_io_performed: true,
        output_io_performed: true,
        native_io_certificate_status: "scoped_compatibility_import_and_local_jsonl_output_certificate",
        generated_source_certificate_status: "not_applicable",
        ...
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "scoped local JSON/JSONL source and JSONL sink smoke only; no nested JSON or production claim",
    },
    UniversalCompatibilityRow {
        id: "parquet",
        surface: "Parquet",
    ...
    UniversalCompatibilityRow {
        ...
        native_io_certificate_status: "scoped_compatibility_import_and_local_output_certificate",
        generated_source_certificate_status: "not_applicable",
        blocker_id: "gar-runtime-impl-4f.avro.broader_runtime_evidence_missing",
    ...
    UniversalCompatibilityRow {
        ...
        native_io_certificate_status: "scoped_compatibility_import_and_local_output_certificate",
        generated_source_certificate_status: "not_applicable",
        blocker_id: "gar-runtime-impl-4f.orc.broader_runtime_evidence_missing",
