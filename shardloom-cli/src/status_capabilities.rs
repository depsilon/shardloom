...
const UNIVERSAL_COMPATIBILITY_ROWS: &[UniversalCompatibilityRow] = &[
    ...
    UniversalCompatibilityRow {
        ...
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "feature-gated flat scalar local Avro source smoke only; no schema-evolution, logical-type completeness, Avro output, or production claim",
    },
    UniversalCompatibilityRow {
        id: "orc",
        surface: "ORC",
        ...
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "feature-gated flat scalar local ORC source smoke only; no stripe/statistics runtime, ORC output, or production claim",
    },
    UniversalCompatibilityRow {
        id: "excel",
        surface: "Excel",
