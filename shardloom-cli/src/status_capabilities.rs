...
const UNIVERSAL_COMPATIBILITY_ROWS: &[UniversalCompatibilityRow] = &[
    UniversalCompatibilityRow {
        ...
        native_io_certificate_status: "local_source_state_vortex_ingest_and_output_certificate",
    ...
    UniversalCompatibilityRow {
        ...
        source_io_performed: true,
        output_io_performed: true,
        native_io_certificate_status: "local_source_state_vortex_ingest_and_local_jsonl_output_certificate",
        generated_source_certificate_status: "not_applicable",
    ...
    UniversalCompatibilityRow {
        ...
        source_io_performed: true,
        output_io_performed: true,
        native_io_certificate_status: "local_columnar_source_state_vortex_ingest_and_output_certificate",
        generated_source_certificate_status: "not_applicable",
        blocker_id: "none_feature_gated_local_parquet_adapter_runtime_supported",
        required_future_evidence: "nested_type_metadata_fidelity_table_object_store_production_evidence",
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "feature-gated flat scalar local Parquet source and sink smoke only; no broad Parquet type/nesting, metadata-fidelity, table, or production claim",
    },
    UniversalCompatibilityRow {
        id: "arrow_ipc",
        surface: "Arrow IPC",
        ...
        native_io_certificate_status: "local_columnar_source_state_vortex_ingest_and_output_certificate",
        generated_source_certificate_status: "not_applicable",
        blocker_id: "none_feature_gated_local_arrow_ipc_adapter_runtime_supported",
        required_future_evidence: "zero_copy_streaming_nested_type_default_build_object_store_production_evidence",
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "feature-gated flat scalar local Arrow IPC source and sink smoke only; no zero-copy, nested type, broad Arrow runtime, or production claim",
    },
    UniversalCompatibilityRow {
        id: "avro",
        surface: "Avro",
        ...
        native_io_certificate_status: "local_columnar_source_state_vortex_ingest_and_output_certificate",
        generated_source_certificate_status: "not_applicable",
        blocker_id: "none_feature_gated_local_avro_adapter_runtime_supported",
        required_future_evidence: "schema_evolution_logical_type_object_store_table_production_evidence",
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "feature-gated flat scalar local Avro source and sink smoke only; no schema-evolution, logical-type completeness, or production claim",
    },
    UniversalCompatibilityRow {
        id: "orc",
        surface: "ORC",
        ...
        native_io_certificate_status: "local_columnar_source_state_vortex_ingest_and_output_certificate",
        generated_source_certificate_status: "not_applicable",
        blocker_id: "none_feature_gated_local_orc_adapter_runtime_supported",
        required_future_evidence: "stripe_statistics_nested_type_object_store_table_production_evidence",
        claim_gate_status: "fixture_smoke_only",
        claim_boundary: "feature-gated flat scalar local ORC source and sink smoke only; no stripe/statistics runtime or production claim",
    },
    UniversalCompatibilityRow {
        id: "excel",
        surface: "Excel",
...
const RUNS_TODAY_SUPPORT_ROWS: &[RunsTodaySupportRow] = &[
    ...
    RunsTodaySupportRow {
        ...
        family: "python_api",
        surface: "ctx.read,read_csv,read_json,read_parquet,read_arrow_ipc,read_avro,read_orc,sql,LazyFrame.collect/write local-file auto route",
        support_state: "executable",
        ...
        blocker_id: "none",
        claim_gate_status: "not_claim_grade",
        claim_boundary: "scoped local Python/SQL/DataFrame workflows normalize through Vortex preparation or native Vortex input before admitted native primitive/provider execution where those routes exist; remaining scoped product-local operators require Vortex preparation but are not native Vortex middle claims. Direct decoded local-source smoke remains internal-only; no arbitrary SQL/DataFrame, object-store/table, fallback, or performance claim",
        runtime_execution: true,
        data_read: true,
        write_io: true,
        fallback_attempted: false,
