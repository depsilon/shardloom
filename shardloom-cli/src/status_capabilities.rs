...
const RUNS_TODAY_SUPPORT_ROWS: &[RunsTodaySupportRow] = &[
    ...
    RunsTodaySupportRow {
        ...
        family: "execution_mode",
        surface: "live-hybrid-durable-checkpoint-smoke,local checkpoint JSON,local changelog JSONL,restore digest",
        support_state: "executable",
        feature_gate: "default",
        evidence_refs: "live-hybrid-durable-checkpoint-smoke <checkpoint-dir>,shardloom.live_hybrid_durable_checkpoint_fixture.v1,cg22.live_hybrid.fixture.durable_checkpoint.native_io",
        blocker_id: "prod-ready-1e.production_state_store_broker_object_store_exactly_once_blocked",
        claim_gate_status: "not_claim_grade",
        claim_boundary: "scoped local filesystem checkpoint/changelog fixture only; no broker, object-store checkpoint, Vortex micro-segment persistence, cold Vortex promotion, exactly-once, production streaming, performance, or Spark-displacement claim",
        runtime_execution: true,
        data_read: false,
        write_io: true,
        fallback_attempted: false,
