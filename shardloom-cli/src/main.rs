...
use shardloom_core::{
    ...
    CorrectnessFixture, CorrectnessValidationPlan, CpuOperatorSpecializationReport, DatasetRef,
    DatasetUri, ExecutionCertificate, ExpectedOutcome, NativeIoCertificate,
    OperatorMemoryCertification, OutputFormat, PredicateExpr, ShardLoomError, StatValue,
};
use shardloom_exec::{
...
use shardloom_plan::{AdaptiveOptimizerMemoryReport, ProjectionRequest};
