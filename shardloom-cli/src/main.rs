...
mod tests {
    ...
    fn usage_includes_cg22_engine_fabric_plans() {
        ...
        assert!(
            cli_usage_line().contains("security-governance|engines|workflow|remote-api|cross-cg]")
        );
    }
    #[test]
