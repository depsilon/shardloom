...
use shardloom_core::{
    ...
    BenchmarkResult, BenchmarkScenario, ByteRange, CatalogMetadataIntegrationGateReport,
    ...
    NativeIoCertificate, Nullability, ObservabilitySchemaCoverageReport,
    OperatorMemoryCertification, OutputFormat, PartitionEvolutionCompatibilityReport,
    PartitionField, PartitionSpec, PartitionTransform, PredicateExpr,
    ...
    ReleaseReadinessEvidenceReport, SchemaDefinition, SchemaEvolutionCompatibilityReport,
    SchemaEvolutionPolicy, SchemaField, SchemaId, SchemaVersion,
    SecurityGovernanceEvidenceGateReport, SegmentChange, SegmentChangeKind, SegmentId,
    ...
    TableCompatibilityReport, TableFormatKind, TableIntelligenceReport, WorkloadClass,
...
use shardloom_exec::{
    ...
    ByteSize, CommitExecutionPromotionGateReport, DynamicRuntimePromotionGateReport,
    ...
    FaultTolerancePromotionGateReport, MemoryBudget, MemoryRuntimeHardeningGateReport,
    OperatorMemorySpillDeclarationReport, ShardLoomCancellationExecutionGateReport,
    ...
    StreamingPlanSkeleton, StreamingSink, StreamingSource, plan_backpressure,
...
use shardloom_vortex::{
    VortexAdaptiveSizingReport, VortexBoundedExecutionReport, VortexCommitIntentSignal,
    VortexCommitMarkerSignal, VortexCommitMarkerWriteOption, VortexCommitProtocolSignal,
    ...
    VortexEncodedReadMetadataProbeReport, VortexEncodedReadMetadataProbeSignal,
    VortexExecutionReadinessStatus, VortexFinalizedManifestArtifactWriteOption,
    VortexFinalizedManifestContent, VortexLayoutReaderDriverApprovalSignal,
    ...
    VortexMetadataFilterKernelAdmissionReport, VortexMetadataSummaryReport,
    VortexOutputPayloadSignal, VortexProjectionReadinessSignal, VortexQueryPrimitiveRequest,
    VortexQueryPrimitiveResult, VortexQueryPrimitiveValue, VortexSchedulerBridgeReport,
...
mod tests {
    ...
    use shardloom_core::{
        ...
        NativeIoSourcePushdownReport, RepresentationState, plan_rfc_coverage_followthrough,
    };
