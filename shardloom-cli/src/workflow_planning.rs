...
fn workflow_unsupported_sample() -> WorkflowUnsupportedOperation {
    WorkflowUnsupportedOperation {
        ...
        blocker_id: "cg21.workflow.sample.rng_object_contract_missing",
        required_evidence: "native_vortex_rng_object_contract,deterministic_seed_policy,semantic_conformance_suite,execution_certificate,no_fallback_evidence",
        suggested_next_action: "Use sample(n=..., seed|random_state=<int>, weights=<column>, replace=False|True) or sample(frac|fraction=..., seed|random_state=<int>, weights=<column>, replace=False|True); opaque pandas/NumPy RNG-object variants need a separate deterministic RNG-state contract before execution.",
        diagnostic_code: DiagnosticCode::NotImplemented,
        materialization_required: false,
        write_required: false,
        runtime_required: true,
...
fn workflow_unsupported_mask() -> WorkflowUnsupportedOperation {
    WorkflowUnsupportedOperation {
        ...
        blocker_id: "cg21.workflow.mask.alignment_callable_or_nested_contract_missing",
        required_evidence: "native_vortex_expression_project_primitive,typed_scalar_or_null_rewrite_payload,execution_certificate,no_fallback_evidence",
        suggested_next_action: "Use scoped mask(predicate, scalar-or-null) over declared/projection columns; callable/alignment and nested variants need explicit validity and expression-kernel evidence.",
        diagnostic_code: DiagnosticCode::UnsupportedSql,
        materialization_required: true,
        write_required: false,
        runtime_required: true,
