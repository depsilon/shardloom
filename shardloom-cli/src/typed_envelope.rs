...
const UNIVERSAL_HARNESS_REPORT_PAYLOAD_KEYS: &[&str] = &[
    "mode",
    "execution",
    "plan_only",
    "schema_version",
    "report_id",
    "universal_harness_status",
...
const INPUT_ADAPTER_CAPABILITY_SNAPSHOT_KEYS: &[&str] = &[
    ...
    "sqlite_status",
    "postgres_mysql_status",
    "jdbc_odbc_status",
    "snowflake_status",
    "bigquery_status",
    "databricks_sql_status",
...
fn inline_report_payload_spec(command: &str) -> Option<InlineReportPayloadSpec> {
    match command {
        ...
        "universal-harness-plan" => Some(InlineReportPayloadSpec {
            artifact_id_fallback: "universal-harness-plan.report",
            artifact_kind: "universal_harness_report",
            status_key: "universal_harness_status",
            payload_keys: UNIVERSAL_HARNESS_REPORT_PAYLOAD_KEYS,
        }),
