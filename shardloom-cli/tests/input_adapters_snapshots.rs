...
fn input_adapters_json_exposes_common_universal_io_formats() {
    ...
    assert!(output.contains(&field("adapter_count", "32")));
    assert!(output.contains(&field("supported_adapter_count", "0")));
