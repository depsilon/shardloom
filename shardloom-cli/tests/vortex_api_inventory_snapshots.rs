...
#[test]
fn vortex_api_inventory_exposes_vortex_upstream_heavy_operator_disposition() {
    let output = run_vortex_api_inventory_json();

    assert!(output.contains(&field(
        "vortex_upstream_heavy_operator_schema_version",
        "shardloom.vortex_upstream_heavy_operator_provider_disposition.v1"
    )));
    assert!(output.contains(&field(
        "vortex_upstream_heavy_operator_report_id",
        "perf-runtime-7b.vortex_upstream.heavy_operator_provider_disposition"
    )));
    assert!(output.contains(&field(
        "vortex_upstream_heavy_operator_phase_id",
        "PERF-RUNTIME-7B"
    )));
    assert!(output.contains(&field(
        "vortex_upstream_heavy_operator_row_order",
    ...
    assert!(output.contains(&field(
        "vortex_upstream_heavy_operator_provider_candidate_count",
        "2"
    )));
    assert!(output.contains(&field(
        "vortex_upstream_heavy_operator_wrapped_shardloom_kernel_count",
        "0"
    )));
    assert!(output.contains(&field(
        "vortex_upstream_heavy_operator_shared_runtime_evidence_count",
        "2"
    )));
    assert!(output.contains(&field(
        "vortex_upstream_heavy_operator_current_runtime_drop_decision_count",
        "2"
    )));
    assert!(output.contains(&field(
        "vortex_upstream_heavy_operator_blocked_external_integration_count",
        "1"
    )));
    assert!(output.contains(&field(
        "vortex_upstream_heavy_operator_claim_gate_status",
        "not_claim_grade"
    )));
    assert!(output.contains(&field(
        "vortex_upstream_heavy_operator_row_grouped_sum_count_aggregate_status",
        "current_runtime_drop_decision"
    )));
    assert!(output.contains(&field(
        "vortex_upstream_heavy_operator_row_grouped_sum_count_aggregate_shardloom_disposition",
        "candidate_only_for_pre_grouped_vortex_arrays_current_flat_column_routes_keep_shardloom_capillary_hash_state"
    )));
    assert!(output.contains(&field(
        "vortex_upstream_heavy_operator_row_grouped_sum_count_aggregate_required_evidence",
    ...
    assert!(output.contains(&field(
        "vortex_upstream_heavy_operator_row_validity_mask_no_null_status",
        "shared_runtime_evidence_recorded"
    )));
    assert!(output.contains(&field(
        "vortex_upstream_heavy_operator_row_byte_length_expression_status",
        "current_runtime_drop_decision"
    )));
    assert!(output.contains(&field(
        "vortex_upstream_heavy_operator_row_layout_child_cache_status",
        "shared_runtime_evidence_recorded"
    )));
    assert!(output.contains(&field(
        "vortex_upstream_heavy_operator_row_datafusion_54_integration_status",
        "blocked_external_integration"
    )));
    assert!(output.contains(&field(
        "vortex_upstream_heavy_operator_row_datafusion_54_integration_shardloom_disposition",
        "baseline_or_oracle_only_not_shardloom_runtime_provider"
    )));
}

#[test]
fn vortex_api_inventory_keeps_vortex_upstream_heavy_operator_disposition_effect_free() {
    let output = run_vortex_api_inventory_json();

    for key in [
        "vortex_upstream_heavy_operator_runtime_execution",
        "vortex_upstream_heavy_operator_data_read",
        "vortex_upstream_heavy_operator_data_decoded",
        "vortex_upstream_heavy_operator_data_materialized",
        "vortex_upstream_heavy_operator_object_store_io",
        "vortex_upstream_heavy_operator_write_io",
        "vortex_upstream_heavy_operator_external_engine_invoked",
        "vortex_upstream_heavy_operator_fallback_attempted",
        "vortex_upstream_heavy_operator_fallback_execution_allowed",
    ] {
        assert!(
            output.contains(&field(key, "false")),
            "missing false field {key}"
    ...
    assert!(output.contains(&field(
        "vortex_upstream_heavy_operator_side_effect_free",
        "true"
    )));
}

#[test]
fn vortex_api_inventory_exposes_vortex_upstream_local_io_provider_disposition() {
    let output = run_vortex_api_inventory_json();
    ...
    assert!(output.contains(&field("vortex_upstream_local_io_phase_id", "PROD-READY-1A")));
    assert!(output.contains(&field(
    ...
    assert!(output.contains(&field(
        "vortex_upstream_local_io_row_layout_reader_context_cache_status",
        "shared_runtime_evidence_recorded"
    )));
    assert!(output.contains(&field(
        "vortex_upstream_local_io_row_json_extension_arrow_interop_shardloom_disposition",
        "candidate_for_json_extension_preservation_and_deterministic_expression_blockers"
    )));
    assert!(output.contains(&field(
        "vortex_upstream_local_io_row_wkb_geospatial_extension_required_evidence",
        "provider_gate,wkb_extension_fidelity_report,geo_execution_blocker,translation_report,native_io_certificate"
    )));
    assert!(output.contains(&field(
        "vortex_upstream_local_io_row_arrow_device_gpu_path_status",
        "blocked_future_device_track"
    )));
    assert!(output.contains(&field(
        "vortex_upstream_local_io_row_arrow_device_gpu_path_shardloom_disposition",
        "blocked_future_device_track_not_local_cpu_v1"
    )));
}

#[test]
fn vortex_api_inventory_keeps_vortex_upstream_local_io_provider_disposition_effect_free() {
    let output = run_vortex_api_inventory_json();
    ...
    assert!(output.contains(&field("vortex_upstream_local_io_side_effect_free", "true")));
}
