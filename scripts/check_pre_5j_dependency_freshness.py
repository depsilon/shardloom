...
ADMITTED_DEPENDABOT_PRS: dict[int, dict[str, Any]] = {
    ...
    1151: {
        ...
        "expected_lock_versions": {"serde_json": "1.0.151"},
        "review_doc": "docs/dependencies/json-digest-dependency-review.md",
        "review_markers": [
            "https://github.com/depsilon/shardloom/pull/1151",
            "serde_json = 1.0.151",
            "MIT OR Apache-2.0",
            "fallback execution",
        ],
    ...
    1153: {
        ...
        "expected_manifest_version": "0.40.2",
        ...
        "review_markers": [
            "https://github.com/depsilon/shardloom/pull/1153",
            "rusqlite = 0.40.2",
