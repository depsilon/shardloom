...
4D/5G/F1 closeout note: current release-gated admitted semantics now include `matrix_row_count=50`
and `executable_fixture_count=39`, including scoped UTF-8 regex predicates, composed string functions, temporal arithmetic/
...
union dtype, binary-source, scalar-left multi-column IN-subquery, correlated subquery, and
...
IN-subquery, correlated, and other non-admitted
