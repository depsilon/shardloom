...
union dtype, direct binary literal predicates over source columns, SQL source-column binary ordering without explicit cast, binary source predicates/order/sinks beyond scoped projection, scalar-left multi-column IN-subquery, unbound qualified references, and remaining non-admitted broad ANSI subquery shapes, and
