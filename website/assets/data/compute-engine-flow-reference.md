...
`claim_gate_status`. SourceState, VortexPreparedState, and OutputPlan rows expose their current
scoped subsets; fanout and broader sink artifact proof remain planned.
