...
`sl.col("event_date").cast("date32").fill_null(date(2026, 1, 1))`. Literal projections emit
...
`null_coalesce_projection_*` evidence. Mixed `int64`/`float64` arithmetic promotes to `float64`
