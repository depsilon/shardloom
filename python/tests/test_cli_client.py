...
class ShardLoomClientTests(unittest.TestCase):
        ...
        binary = self.fake_cli(
            textwrap.dedent(
                ...
                fields = [
                    ...
                    ["command_registry_user_surface_graduation_posture_vocabulary", "high_level_context,public_runtime,client_only,diagnostic_only,feature_gated,not_user_facing"],
                    ...
                    ["registered_command_user_surface_graduation_postures", "help=diagnostic_only,command-metadata=diagnostic_only,status=diagnostic_only,vortex-prepare=public_runtime"],
                    ...
                    ["selected_command_user_surface_graduation_posture", "public_runtime"],
            ...
            textwrap.dedent(
                ...
                print(json.dumps({
                    ...
                    "fields": [
                        ...
                        {"key": "vortex_layout_write_advisor_selected_strategy", "value": "single_vortex_artifact_embedded_olap_layout_statistics"},
                        ...
                        {"key": "vortex_layout_write_advisor_layout_strategy", "value": "single_vortex_artifact_embedded_olap_layout_statistics"},
    ...
    def test_context_capabilities_collects_typed_views_without_dataset_commands(self) -> None:
        ...
        self.assertFalse(dataframe_methods.row("sql").write_io)
        ...
        self.assertIn(
            ...
            dataframe_methods.row("join").required_evidence,
        )
        self.assertEqual(
        ...
        self.assertIn(
            ...
            dataframe_methods.row("sort").required_evidence,
        )
        self.assertEqual(
            ...
            textwrap.dedent(
                ...
                print(json.dumps({
                    ...
                    "fields": [
                        ...
                        {"key": "compute_row_sql_frontend_execution_mode", "value": "prepared_vortex"},
