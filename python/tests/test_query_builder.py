...
_FAKE_CLI_ENVELOPE_PRELUDE = textwrap.dedent(
    ...
    def _shardloom_emit_prepared_native_vortex_probe_if_needed():
        ...
        if requested_output in {"write_jsonl", "write_csv"} and primitive is not None:
            ...
            target_formats = [output_format] + [value.split("=", 1)[0] for value in fanout_outputs]
            target_paths = [output_ref or "target/missing-output"] + [
                value.split("=", 1)[1] if "=" in value else value for value in fanout_outputs
            ]
            rows_written = ["2" for _ in target_paths]
            fields = [
                ["public_workflow_facade_schema_version", "shardloom.public_workflow_execution_facade.v1"],
                ["public_workflow_route_attached", "true"],
                ["public_workflow_facade_command", "run"],
                ...
                ["public_workflow_vortex_normalization_point", "VortexPreparedState"],
                ["public_workflow_vortex_middle_status", "native_vortex_primitive_row_export"],
                ["public_workflow_execution_mode", "native_vortex"],
                ["public_workflow_preparation_included", "false"],
                ["public_workflow_requested_output", requested_output],
                ["public_workflow_output_ref", output_ref or ""],
                ...
                ["native_vortex_result_export_format", output_format],
                ["native_vortex_result_export_path", output_ref or ""],
                ["native_vortex_result_export_rows_written", "2"],
                ["native_vortex_result_export_target_count", str(len(target_paths))],
                ["native_vortex_result_export_fanout_count", str(len(fanout_outputs))],
                ["native_vortex_result_export_fanout_performed", "true" if fanout_outputs else "false"],
                ["native_vortex_result_export_target_roles", ",".join(target_roles)],
            ...
            print(_shardloom_json.dumps({
                ...
                "command": "run",
                "status": "success",
                "summary": "prepared native Vortex primitive row export",
                "human_text": "prepared native Vortex primitive row export",
                "fallback": {"attempted": False, "allowed": False, "engine": None, "reason": "disabled"},
                "diagnostics": [],
                "fields": [{"key": key, "value": value} for key, value in fields],
            }))
...
_RETIRED_PUBLIC_LOCAL_SQL_SMOKE_TESTS = frozenset(
    """
test_column_expression_builder_exposes_date_extract_report_fields
test_column_expression_builder_exposes_string_function_report_fields
test_column_expression_builder_exposes_string_transform_report_fields
test_column_expression_builder_exposes_timestamp_arithmetic_report_fields
test_column_expression_builder_exposes_timestamp_report_fields
test_column_expression_builder_lowers_boolean_predicates
test_column_expression_builder_lowers_is_not_boolean_predicates
test_column_expression_builder_lowers_to_sql_filter_predicates
...
test_group_by_without_aggregate_cannot_lower_to_projection_smoke
test_local_arrow_ipc_query_builder_collect_invokes_sql_smoke
test_local_avro_query_builder_collect_invokes_sql_smoke
test_local_csv_query_builder_aggregate_having_invokes_sql_smoke
test_local_csv_query_builder_aliases_lower_to_existing_runtime_paths
test_local_csv_query_builder_binary_byte_length_invokes_sql_smoke
test_local_csv_query_builder_binary_helper_predicate_invokes_sql_smoke
test_local_csv_query_builder_binary_helper_projection_invokes_sql_smoke
test_local_csv_query_builder_collect_invokes_sql_smoke
test_local_csv_query_builder_collect_limit_parameter_invokes_sql_smoke
...
test_local_csv_query_builder_count_distinct_aggregate_invokes_sql_smoke
test_local_csv_query_builder_count_invokes_scalar_aggregate_smoke
test_local_csv_query_builder_cross_join_invokes_sql_smoke
...
test_local_csv_query_builder_exists_subquery_filter_invokes_sql_smoke
test_local_csv_query_builder_expression_join_invokes_sql_smoke
test_local_csv_query_builder_fanout_invokes_sql_smoke_outputs
test_local_csv_query_builder_filter_after_aggregate_topn_stays_unsupported
test_local_csv_query_builder_filter_after_having_stays_unsupported
test_local_csv_query_builder_generic_expression_filter_invokes_sql_smoke
test_local_csv_query_builder_group_by_aggregate_invokes_sql_smoke
test_local_csv_query_builder_group_by_aggregate_order_by_topn_invokes_sql_smoke
test_local_csv_query_builder_group_key_order_by_topn_invokes_sql_smoke
test_local_csv_query_builder_groupby_count_sort_aliases_invoke_sql_smoke
test_local_csv_query_builder_grouped_projected_subquery_helpers_invoke_sql_smoke
test_local_csv_query_builder_having_exists_subquery_invokes_sql_smoke
test_local_csv_query_builder_having_quantified_subquery_invokes_sql_smoke
test_local_csv_query_builder_having_unprojected_aggregate_invokes_sql_smoke
test_local_csv_query_builder_in_filter_invokes_sql_smoke
test_local_csv_query_builder_in_subquery_filter_invokes_sql_smoke
test_local_csv_query_builder_intersect_invokes_sql_smoke
test_local_csv_query_builder_join_computed_projection_topn_invokes_sql_smoke
test_local_csv_query_builder_join_invokes_sql_smoke
test_local_csv_query_builder_join_scalar_aggregate_invokes_sql_smoke
test_local_csv_query_builder_join_scalar_aggregate_order_by_topn_invokes_sql_smoke
test_local_csv_query_builder_join_topn_invokes_sql_smoke
test_local_csv_query_builder_join_write_invokes_sql_smoke_output
test_local_csv_query_builder_left_outer_join_invokes_sql_smoke
test_local_csv_query_builder_like_escape_invokes_sql_smoke
test_local_csv_query_builder_logical_and_filter_invokes_sql_smoke
test_local_csv_query_builder_logical_not_filter_invokes_sql_smoke
test_local_csv_query_builder_logical_or_filter_invokes_sql_smoke
test_local_csv_query_builder_merge_lowers_to_join
test_local_csv_query_builder_multi_key_group_by_aggregate_invokes_sql_smoke
test_local_csv_query_builder_multi_key_join_group_by_aggregate_invokes_sql_smoke
test_local_csv_query_builder_multi_key_join_invokes_sql_smoke
test_local_csv_query_builder_multi_key_order_by_topn_invokes_sql_smoke
test_local_csv_query_builder_named_multi_key_group_by_aggregate_invokes_sql_smoke
test_local_csv_query_builder_named_scalar_aggregate_invokes_sql_smoke
test_local_csv_query_builder_null_aware_in_filter_invokes_sql_smoke
...
test_local_csv_query_builder_order_by_topn_invokes_sql_smoke
test_local_csv_query_builder_outer_correlation_unsupported_diagnostics_passthrough
test_local_csv_query_builder_parenthesized_filter_invokes_sql_smoke
test_local_csv_query_builder_predicate_or_join_condition_invokes_sql_smoke
test_local_csv_query_builder_preview_uses_select_star_limit
test_local_csv_query_builder_projection_limit_without_filter_invokes_sql_smoke
test_local_csv_query_builder_quantified_subquery_filter_invokes_sql_smoke
test_local_csv_query_builder_quarantine_writes_pushdown_not_null_rows
test_local_csv_query_builder_quarantine_writes_pushdown_regex_rows
test_local_csv_query_builder_regex_predicate_invokes_sql_smoke
test_local_csv_query_builder_right_join_invokes_sql_smoke
test_local_csv_query_builder_row_value_in_filter_invokes_sql_smoke
test_local_csv_query_builder_row_value_in_subquery_filter_invokes_sql_smoke
test_local_csv_query_builder_scalar_aggregate_invokes_sql_smoke
test_local_csv_query_builder_scalar_aggregate_order_by_topn_invokes_sql_smoke
test_local_csv_query_builder_schema_quality_helpers_invoke_sql_smoke
test_local_csv_query_builder_to_python_objects_invokes_sql_smoke
...
test_local_csv_query_builder_utf8_order_by_topn_invokes_sql_smoke
test_local_csv_query_builder_value_counts_lowers_to_grouped_count
test_local_csv_query_builder_where_between_invokes_sql_smoke
test_local_csv_query_builder_where_negated_predicates_invoke_sql_smoke
test_local_csv_query_builder_window_rank_dense_rank_invokes_sql_smoke
test_local_csv_query_builder_window_row_number_invokes_sql_smoke
test_local_csv_query_builder_with_column_cast_invokes_sql_smoke
test_local_csv_query_builder_with_column_complex_projection_invokes_sql_smoke
test_local_csv_query_builder_with_column_conditional_invokes_sql_smoke
test_local_csv_query_builder_with_column_date_arithmetic_invokes_sql_smoke
test_local_csv_query_builder_with_column_generic_expression_invokes_sql_smoke
test_local_csv_query_builder_with_column_literal_invokes_sql_smoke
test_local_csv_query_builder_with_column_literal_write_csv_invokes_sql_smoke
test_local_csv_query_builder_with_column_null_coalesce_invokes_sql_smoke
test_local_csv_query_builder_with_column_nullif_invokes_sql_smoke
test_local_csv_query_builder_with_column_numeric_abs_invokes_sql_smoke
test_local_csv_query_builder_with_column_numeric_arithmetic_invokes_sql_smoke
test_local_csv_query_builder_with_column_numeric_rounding_invokes_sql_smoke
test_local_csv_query_builder_with_column_predicate_invokes_sql_smoke
test_local_csv_query_builder_with_column_string_function_invokes_sql_smoke
test_local_csv_query_builder_with_column_string_length_invokes_sql_smoke
test_local_csv_query_builder_with_column_string_transform_invokes_sql_smoke
test_local_csv_query_builder_with_column_temporal_difference_invokes_sql_smoke
test_local_csv_query_builder_with_column_temporal_extract_invokes_sql_smoke
test_local_csv_query_builder_with_column_timestamp_arithmetic_invokes_sql_smoke
test_local_csv_query_builder_with_columns_assign_aliases_invoke_sql_smoke
test_local_csv_query_builder_with_decimal_arithmetic_invokes_sql_smoke
test_local_csv_query_builder_with_decimal_cast_invokes_sql_smoke
test_local_csv_query_builder_with_try_cast_invokes_sql_smoke
test_local_csv_query_builder_write_arrow_ipc_invokes_sql_smoke_output
test_local_csv_query_builder_write_avro_and_orc_normalize_formats
test_local_csv_query_builder_write_csv_invokes_sql_smoke_output
test_local_csv_query_builder_write_invokes_sql_smoke_output
test_local_json_query_builder_join_invokes_sql_smoke
test_local_json_query_builder_with_column_sort_invokes_sql_smoke
test_local_json_query_builder_with_column_without_select_invokes_sql_smoke
test_local_orc_query_builder_collect_invokes_sql_smoke
test_local_parquet_query_builder_collect_invokes_sql_smoke
test_missing_dataframe_affordances_return_report_only_unsupported
test_read_json_plain_json_projection_filter_limit_invokes_sql_smoke
test_read_json_query_builder_group_by_aggregate_invokes_sql_smoke
test_read_json_query_builder_order_by_topn_invokes_sql_smoke
test_read_json_query_builder_projection_filter_limit_invokes_sql_smoke
test_read_json_query_builder_scalar_aggregate_invokes_sql_smoke
...
test_session_sql_local_source_limit_chain_collect_invokes_sql_smoke
test_sql_preview_caps_existing_top_level_limit
    """.split()
)
...
class LazyWorkflowBuilderTests(unittest.TestCase):
    ...
    def test_workflow_run_uses_public_facade_with_attached_route(self) -> None:
        ...
        with self.assertRaises(sl.ShardLoomCommandError) as raised:
            ctx.read_csv("target/input.csv").select("id").limit(10).run()

        execution = sl.PublicWorkflowExecution(raised.exception.envelope)
        self.assertEqual(execution.facade_command, "run")
        self.assertTrue(execution.route_attached)
        self.assertEqual(execution.route_id, "blocked")
        self.assertEqual(execution.resolved_internal_command, "not_resolved")
    ...
    def test_lazyframe_fanout_uses_public_run_facade_payload(self) -> None:
        ...
        self.assertEqual(
            ...
            "target/input.jsonl,target/input.csv.out",
        )
    ...
    def test_dataframe_source_free_projection_writes_literal_projection(self) -> None:
        binary = self.fake_cli(
            textwrap.dedent(
                """
                import json, sys
                ...
                assert sys.argv[1:] == [
                    "generated-source-user-rows-smoke",
                    "target/dataframe-projection.jsonl",
                ...
                print(json.dumps({
                    ...
                    "command": "generated-source-user-rows-smoke",
                    "status": "success",
                    "summary": "dataframe source-free projection",
                    "human_text": "dataframe source-free projection",
                    "fallback": {"attempted": False, "allowed": False, "engine": None, "reason": "disabled"},
                    "diagnostics": [],
                    "fields": [
                        {"key": "output_path", "value": "target/dataframe-projection.jsonl"},
                        {"key": "generated_source_kind", "value": "dataframe_source_free_projection"},
                        {"key": "generated_source_row_count", "value": "1"},
                        {"key": "generated_source_created", "value": "true"},
                        {"key": "source_io_performed", "value": "false"},
                        {"key": "output_io_performed", "value": "true"},
                        {"key": "materialization_boundary", "value": "python_dataframe_source_free_projection_to_local_jsonl_sink"},
                        {"key": "generated_source_certificate_status", "value": "present"},
                        {"key": "output_native_io_certificate_status", "value": "certified_local_file_sink"},
                        {"key": "fallback_attempted", "value": "false"},
                        {"key": "external_engine_invoked", "value": "false"},
        ...
        report = ctx.dataframe_source_free_projection(
            "lit(1).alias('value')",
            ("label", "alpha"),
        ).write("target/dataframe-projection.jsonl")

        self.assertEqual(report.envelope.command, "generated-source-user-rows-smoke")
        self.assertEqual(report.generated_source_kind, "dataframe_source_free_projection")
        self.assertEqual(report.generated_source_row_count, 1)
        self.assertFalse(report.fallback_attempted)
        self.assertFalse(report.external_engine_invoked)
        self.assertEqual(report.claim_gate_status, "fixture_smoke_only")

        source = sl.dataframe_source_free_projection(
            {"value": 1, "label": "alpha"},
            binary=binary,
        )
    ...
    def test_dataframe_generated_with_column_writes_literal_generated_column(self) -> None:
        ...
        with self.assertRaisesRegex(ValueError, r"lit\(\.\.\.\)\.alias"):
            ctx.dataframe_source_free_projection("value + 1")
    ...
    def test_local_csv_query_builder_schema_quality_helpers_invoke_sql_smoke(self) -> None:
        ...
        contract = workflow.schema_contract(
            {"id": "int64", "label": "string", "amount": "int64"}
        )
        ...
        self.assertFalse(contract.external_engine_invoked)
        ...
        self.assertEqual(profile.limit, 100)
        self.assertEqual(profile.row_count, 3)
        self.assertEqual(profile.field_count, 3)
        self.assertEqual(profile.null_counts, {"id": 0, "label": 1, "amount": 0})
        self.assertTrue(profile.runtime_execution)
        self.assertTrue(profile.data_read)
        self.assertFalse(profile.write_io)
        self.assertFalse(profile.fallback_attempted)
        self.assertFalse(profile.external_engine_invoked)
        self.assertIsInstance(quarantine, sl.WorkflowQuarantineReport)
        self.assertEqual(quarantine.quarantine_policy, "bounded_local_source_quarantine.v1")
        self.assertEqual(quarantine.quarantine_status, "report_only")
        self.assertEqual(quarantine.quarantined_row_count, 1)
        self.assertEqual(quarantine.rows, ({"id": 2, "label": None, "amount": 15},))
        self.assertFalse(quarantine.write_io)
        self.assertFalse(quarantine.fallback_attempted)
        self.assertFalse(quarantine.external_engine_invoked)

    def test_local_csv_query_builder_quarantine_writes_pushdown_not_null_rows(self) -> None:
        ...
        quarantine_statement = (
            ...
            "WHERE (amount >= 10) AND (label IS NULL) LIMIT 100"
        )
        binary = self.fake_cli(
            textwrap.dedent(
                f"""
                ...
                if statement == {base + " LIMIT 100"!r}:
                    ...
                    result_jsonl = "{{\\"id\\":2,\\"label\\":null,\\"amount\\":15}}\\n"
                    output_path = "target/bad.jsonl"
                    output_format = "jsonl"
                    row_count = "1"
                else:
                    raise AssertionError(sys.argv)
        ...
        self.assertEqual(report.output_path, "target/bad.jsonl")
    ...
    def test_context_sql_schema_quality_helpers_invoke_sql_smoke(self) -> None:
        ...
        profile = workflow.profile(limit=2)
        ...
        self.assertFalse(by_check["unique:label"].passed)
        self.assertIsInstance(profile, sl.WorkflowProfileReport)
        self.assertEqual(profile.limit, 2)
    ...
    def test_local_csv_query_builder_row_value_in_filter_invokes_sql_smoke(self) -> None:
        binary = self.fake_cli(
            textwrap.dedent(
                """
                import json, sys
                ...
                print(json.dumps({
                    ...
                    "fields": [
                        {"key": "result_jsonl", "value": "{\\"id\\":1,\\"label\\":\\"alpha\\"}\\n{\\"id\\":3,\\"label\\":\\"gamma\\"}\\n"},
                        {"key": "predicate_operator_family", "value": "row_value_in_predicate"},
                        {"key": "in_predicate_runtime_execution", "value": "true"},
                        {"key": "in_list_value_count", "value": "3"},
                        {"key": "in_list_null_value_count", "value": "1"},
                        {"key": "row_value_in_predicate_runtime_execution", "value": "true"},
                        {"key": "row_value_in_source_columns", "value": "id,label"},
                        {"key": "row_value_in_column_groups", "value": "id+label"},
                        {"key": "row_value_in_column_count", "value": "2"},
                        {"key": "row_value_in_tuple_count", "value": "3"},
                        {"key": "row_value_in_null_value_count", "value": "1"},
                        {"key": "row_value_in_null_semantics", "value": "sql_row_value_three_valued_where_filter"},
                        {"key": "in_predicate_null_semantics", "value": "sql_three_valued_where_filter"},
                        {"key": "output_row_count", "value": "2"},
                        {"key": "selected_row_count", "value": "2"},
                        {"key": "output_io_performed", "value": "false"},
        ...
        self.assertEqual(report.in_list_null_value_count, 1)
        self.assertTrue(report.row_value_in_predicate_runtime_execution)
        self.assertEqual(report.row_value_in_source_columns, ("id", "label"))
        self.assertEqual(report.row_value_in_column_groups, ("id+label",))
        self.assertEqual(report.row_value_in_column_count, 2)
        self.assertEqual(report.row_value_in_tuple_count, 3)
        self.assertEqual(report.row_value_in_null_value_count, 1)
        self.assertEqual(
            report.row_value_in_null_semantics,
    ...
    def test_local_csv_query_builder_row_value_in_subquery_filter_invokes_sql_smoke(
        self,
    ) -> None:
        binary = self.fake_cli(
            textwrap.dedent(
                ...
                print(json.dumps({
                    ...
                    "fields": [
                        {"key": "result_jsonl", "value": "{\\"id\\":1,\\"label\\":\\"alpha\\"}\\n{\\"id\\":3,\\"label\\":\\"gamma\\"}\\n"},
                        {"key": "predicate_operator_family", "value": "row_value_in_subquery"},
                        {"key": "in_predicate_runtime_execution", "value": "true"},
                        {"key": "in_list_value_count", "value": "3"},
                        {"key": "in_list_null_value_count", "value": "1"},
                        {"key": "row_value_in_predicate_runtime_execution", "value": "true"},
                        ...
                        {"key": "row_value_in_null_semantics", "value": "sql_row_value_three_valued_where_filter"},
                        {"key": "in_subquery_runtime_execution", "value": "true"},
                        {"key": "in_subquery_source_column", "value": "allowed_id,allowed_label"},
                        {"key": "in_subquery_source_format", "value": "csv"},
                        {"key": "in_subquery_filter_runtime_execution", "value": "true"},
                        {"key": "in_subquery_order_by_runtime_execution", "value": "true"},
                        {"key": "in_subquery_limit_runtime_execution", "value": "true"},
                        {"key": "in_subquery_input_row_count", "value": "5"},
                        {"key": "in_subquery_filtered_row_count", "value": "4"},
                        {"key": "in_subquery_materialization_bound", "value": "32"},
        ...
        self.assertTrue(report.in_subquery_runtime_execution)
        self.assertEqual(
            report.in_subquery_source_columns, ("allowed_id", "allowed_label")
        )
        self.assertEqual(report.in_subquery_source_formats, ("csv",))
        self.assertTrue(report.in_subquery_filter_runtime_execution)
        self.assertTrue(report.in_subquery_order_by_runtime_execution)
        self.assertTrue(report.in_subquery_limit_runtime_execution)
        self.assertEqual(report.in_subquery_input_row_count, 5)
        self.assertEqual(report.in_subquery_filtered_row_count, 4)
        self.assertEqual(report.in_subquery_materialization_bound, 32)
    ...
    def test_local_csv_query_builder_with_columns_assign_aliases_invoke_sql_smoke(
        ...
        binary = self.fake_cli(
            textwrap.dedent(
                ...
                print(json.dumps({
                    ...
                    "diagnostics": [],
                    "fields": [
                        {"key": "result_jsonl", "value": "{\\"id\\":2,\\"gross\\":40,\\"bucket\\":19}\\n"},
                        ...
                        {"key": "generic_expression_projection_source_column", "value": "amount+tax,amount"},
                        {"key": "generic_expression_projection_output_column", "value": "gross,bucket"},
                        {"key": "generic_expression_projection_operator_family", "value": "numeric_binary,numeric_rounding"},
        ...
        report = (
            ctx.read_csv("target/input.csv")
            .project("id")
            .with_columns({"gross": (sl.col("amount") + sl.col("tax")) * 2})
            .assign(bucket=sl.floor(sl.col("amount")))
            .filter(sl.col("amount") >= 10)
            .collect(limit=2)
        )
        ...
        self.assertEqual(
            ...
            ("numeric_binary", "numeric_rounding"),
        )
        self.assertFalse(report.fallback_attempted)
        self.assertFalse(report.external_engine_invoked)
    ...
    def test_local_csv_query_builder_groupby_count_sort_aliases_invoke_sql_smoke(
        ...
        binary = self.fake_cli(
            textwrap.dedent(
                ...
                print(json.dumps({
                    ...
                    "diagnostics": [],
                    "fields": [
                        {"key": "result_jsonl", "value": "{\\"region\\":\\"east\\",\\"rows\\":3}\\n{\\"region\\":\\"west\\",\\"rows\\":2}\\n"},
                        {"key": "sql_statement_kind", "value": "local_source_group_by_aggregate_order_by_topn_filter_limit"},
                        {"key": "group_by_runtime_execution", "value": "true"},
                        {"key": "group_by_columns", "value": "region"},
                        {"key": "group_by_group_count", "value": "2"},
        ...
        grouped = ctx.read_csv("target/input.csv").groupby("region").count()
        self.assertIsInstance(grouped, sl.LazyFrame)
        ...
        self.assertTrue(report.order_by_runtime_execution)
        self.assertTrue(report.top_n_runtime_execution)
        self.assertEqual(report.sort_keys, ("rows",))
        self.assertEqual(report.sort_direction, "desc")
        self.assertFalse(report.fallback_attempted)
        self.assertFalse(report.external_engine_invoked)
    ...
    def test_local_csv_query_builder_with_column_complex_projection_invokes_sql_smoke(
        self,
    ) -> None:
        binary = self.fake_cli(
            textwrap.dedent(
                ...
                print(json.dumps({
                    ...
                    "fields": [
                        ...
                        {"key": "sql_statement_kind", "value": "local_source_complex_projection_filter_limit"},
        ...
        self.assertEqual(
            report.envelope.field("complex_projection_columns"), "values,payload"
        )
        self.assertEqual(
    ...
    def test_local_csv_query_builder_profile_uses_public_blocker_not_sql_smoke(
        ...
        binary = self.fake_cli(
            textwrap.dedent(
                ...
                print(json.dumps({
                    ...
                    "command": "run",
                    "status": "unsupported",
                    "summary": "local source profile blocked before execution",
                    "human_text": "local source profile blocked before execution",
                    "fallback": {"attempted": False, "allowed": False, "engine": None, "reason": "disabled"},
                    "diagnostics": [],
                    "fields": [{"key": key, "value": value} for key, value in fields],
                }))
        ...
        report = ctx.read_csv("target/input.csv").select(["id", "label"]).profile()
    ...
    def test_native_vortex_query_builder_profile_routes_to_metadata_profile(self) -> None:
        binary = self.fake_cli(
            textwrap.dedent(
                """
                import json, sys
                ...
                fields = [
                    ...
                    ["public_workflow_native_vortex_capability_status", "supported"],
                    ["public_workflow_native_vortex_required_feature_gate", "default"],
                    ...
                    ["metadata_summary_plan_only", "true"],
                    ["runtime_execution", "false"],
        ...
        report = ctx.read_vortex("target/fact.vortex").select(["id", "label"]).profile()

        self.assertIsInstance(report, sl.VortexWorkflowExecutionReport)
        self.assertEqual(report.command, "vortex-metadata-summary")
        self.assertEqual(report.envelope.field("public_workflow_route_id"), "native_vortex_user_profile")
        self.assertEqual(report.envelope.field("public_workflow_vortex_middle_status"), "native_vortex_metadata_profile")
        self.assertFalse(report.fallback_attempted)
        self.assertFalse(report.external_engine_invoked)
    ...
    def test_generated_range_dataframe_aliases_invoke_generated_source_sql_smoke(
        self,
    ) -> None:
        statement = (
        ...
        binary = self.fake_cli(
            textwrap.dedent(
                ...
                assert sys.argv[1:] == [
                    "generated-source-sql-smoke",
                    "target/range-query-aliases.jsonl",
                    {statement!r},
                    "--output-format",
                    "jsonl",
                    "--allow-overwrite",
                ...
                print(json.dumps({{
                    ...
                    "status": "success",
                    "summary": "generated sql aliases",
                    "human_text": "generated sql aliases",
                    "fallback": {{"attempted": False, "allowed": False, "engine": None, "reason": "disabled"}},
                    "diagnostics": [],
                    "fields": [
                        {{"key": "output_path", "value": "target/range-query-aliases.jsonl"}},
        ...
        report = (
            ...
            .where(sl.col("id") >= 3)
            .with_columns({"doubled": sl.col("id") * 2})
            .order_by("doubled", descending=True)
            .limit(2)
            .write("target/range-query-aliases.jsonl", allow_overwrite=True)
        )
    ...
    def test_context_sql_local_source_collect_limit_parameter_invokes_sql_smoke(self) -> None:
        statement = "SELECT id FROM 'target/input.csv' WHERE id >= 1 LIMIT 2"
        binary = self.fake_cli(
            textwrap.dedent(
                f"""
    ...
    def test_context_sql_local_source_limit_chain_collect_invokes_sql_smoke(self) -> None:
        statement = "SELECT id FROM 'target/input.csv' WHERE id >= 1 LIMIT 2"
        binary = self.fake_cli(
            textwrap.dedent(
                f"""
        ...
        workflow = ctx.sql("SELECT id FROM 'target/input.csv' WHERE id >= 1").limit(2)
        report = workflow.collect()
    ...
    def test_context_sql_local_source_unbounded_collect_is_deterministic_diagnostic(self) -> None:
        statement = "SELECT id FROM 'target/input.csv'"
        binary = self.fake_cli(
            textwrap.dedent(
                """
                import json, sys
                ...
                print(json.dumps({
                    ...
                    "command": "workflow-unsupported-plan",
                    "status": "unsupported",
                    "summary": "bounded SQL collect requires explicit limit",
                    "human_text": "bounded SQL collect requires explicit limit",
                    "fallback": {"attempted": False, "allowed": False, "engine": None, "reason": "disabled"},
                    "diagnostics": [],
                    "fields": [
                        {"key": "operation", "value": "sql-local-source-collect"},
                        {"key": "workflow_summary", "value": "sql(statement)"},
                        {"key": "target_ref", "value": "local_source_sql_collect_requires_explicit_limit"},
                        {"key": "blocker_id", "value": "cg21.workflow.sql.local_source_collect_requires_limit"},
                        {"key": "runtime_execution", "value": "false"},
                        {"key": "data_read", "value": "false"},
                        {"key": "write_io", "value": "false"},
                        {"key": "fallback_attempted", "value": "false"},
        ...
        self.assertEqual(report.operation, "sql-local-source-collect")
        self.assertEqual(
    ...
    def test_local_csv_query_builder_collect_limit_parameter_invokes_sql_smoke(self) -> None:
        statement = "SELECT id FROM 'target/input.csv' LIMIT 2"
        binary = self.fake_cli(
            textwrap.dedent(
                f"""
                import json, sys
    ...
    def test_vortex_user_operator_shapes_route_to_native_provider(self) -> None:
        binary = self.fake_cli(
            textwrap.dedent(
                ...
                if request in {"write_vortex", "write_jsonl"}:
                    assert family == "sink", args
                    assert scenario == "clean-cast-filter-write", args
                    expected_output = {
                        "write_vortex": "target/out.vortex",
                        "write_jsonl": "target/out.jsonl",
                    }[request]
                    assert args[args.index("--output") + 1] == expected_output, args
        ...
        reports = (
            ...
            .filter(sl.col("amount_float") >= 0)
            .limit(1000)
            .write_jsonl("target/out.jsonl", allow_overwrite=True),
        )
    ...
    def test_sql_vortex_user_operator_shapes_route_to_native_provider(self) -> None:
        ...
        reports = (
            ...
            ctx.sql(clean_sql).write_jsonl(
                "target/sql-out.jsonl",
                allow_overwrite=True,
            ),
        )
    ...
    def test_vortex_query_builder_write_jsonl_uses_primitive_row_export(self) -> None:
        binary = self.fake_cli(
            textwrap.dedent(
                ...
                assert args == [
                    ...
                    "vortex",
                    "--plan",
                    "read_vortex(fact.vortex) -> filter(metric >= 0) -> write_jsonl(target/out.jsonl)",
                    "--request",
                    "write_jsonl",
                    "--output",
                    "target/out.jsonl",
                ...
                print(json.dumps({
                    ...
                    "command": "run",
                    "status": "success",
                    "summary": "native Vortex primitive row export",
                    "human_text": "native Vortex primitive row export",
                    "fallback": {"attempted": False, "allowed": False, "engine": None, "reason": "disabled"},
                    "diagnostics": [],
                    "fields": [
                        {"key": "public_workflow_route_attached", "value": "true"},
                        {"key": "public_workflow_route_id", "value": "native_vortex_primitive_row_export"},
                        {"key": "public_workflow_resolved_internal_command", "value": "vortex-local-primitive-row-export"},
                        {"key": "public_workflow_vortex_primitive", "value": "filter"},
                        {"key": "public_workflow_requested_output", "value": "write_jsonl"},
                        {"key": "execution", "value": "native_vortex_primitive_row_export_performed"},
                        {"key": "native_vortex_result_export_kind", "value": "primitive_row_stream"},
                        {"key": "native_vortex_result_export_format", "value": "jsonl"},
                        {"key": "native_vortex_result_export_rows_written", "value": "3"},
                        {"key": "native_vortex_result_export_target_count", "value": "1"},
                        {"key": "typed_sink_contract", "value": "native_vortex_primitive_row_stream_to_jsonl_csv_compatibility_sink"},
                        {"key": "decode_materialization_boundary", "value": "native_vortex_scan_pushdown_then_selected_column_decode_at_compatibility_sink"},
                        {"key": "data_read", "value": "true"},
        ...
        report = fact.filter(sl.col("metric") >= 0).write_jsonl(
            "target/out.jsonl",
            allow_overwrite=True,
        )
        ...
        self.assertEqual(
            report.envelope.field("native_vortex_result_export_kind"),
    ...
    def test_vortex_query_builder_fanout_uses_primitive_row_export(self) -> None:
        binary = self.fake_cli(
            textwrap.dedent(
                """
                import json, sys
                ...
                assert args == [
                    ...
                    "vortex",
                    "--plan",
                    "read_vortex(fact.vortex) -> select(id,label) -> limit(2) -> write_jsonl(target/out.jsonl)",
                    "--request",
                    "write_jsonl",
                    "--output",
                    "target/out.jsonl",
                ...
                print(json.dumps({
                    ...
                    "fields": [
                        {"key": "public_workflow_route_attached", "value": "true"},
                        {"key": "public_workflow_route_id", "value": "native_vortex_primitive_row_export"},
                        {"key": "public_workflow_fanout_output_count", "value": "1"},
                        {"key": "public_workflow_fanout_outputs", "value": "csv=target/out.csv"},
                        {"key": "execution", "value": "native_vortex_primitive_row_export_performed"},
                        {"key": "native_vortex_result_export_target_count", "value": "2"},
                        {"key": "native_vortex_result_export_fanout_count", "value": "1"},
                        {"key": "native_vortex_result_export_fanout_performed", "value": "true"},
                        {"key": "native_vortex_result_export_target_formats", "value": "jsonl,csv"},
                        {"key": "native_vortex_result_export_target_rows_written", "value": "2,2"},
                        {"key": "fallback_attempted", "value": "false"},
                        {"key": "external_engine_invoked", "value": "false"},
                    ],
                }))
        ...
        report = fact.select("id", "label").limit(2).fanout(
            {"jsonl": "target/out.jsonl", "csv": "target/out.csv"},
            allow_overwrite=True,
        )
        ...
        self.assertEqual(
            report.envelope.field("native_vortex_result_export_target_count"),
            "2",
        )
        self.assertFalse(report.fallback_attempted)
        self.assertFalse(report.external_engine_invoked)
    ...
    def test_sql_vortex_count_project_and_filter_primitives_use_local_runtime(self) -> None:
        binary = self.fake_cli(
            textwrap.dedent(
                """
                import json, sys
                ...
                if primitive == "count":
                    ...
                    fields = [
                        ...
                        {"key": "filter_project_local_execution_rows_selected", "value": "3"},
                        {"key": "filter_project_local_execution_rows_projected", "value": "3"},
                        {"key": "filter_project_local_execution_projected_columns", "value": "*"},
                        {"key": "filter_project_local_execution_fallback_attempted", "value": "false"},
                        {"key": "external_engine_invoked", "value": "false"}
                    ]
        ...
        count = sl.sql("SELECT COUNT(*) FROM 'orders.vortex'", client=client).collect(
            memory_gb=4,
            max_parallelism=2,
        )
        count_where = sl.sql(
            "SELECT COUNT(*) FROM 'orders.vortex' WHERE value >= 3",
            client=client,
        ).collect(memory_gb=4, max_parallelism=2)
        project = sl.sql("SELECT metric FROM 'orders.vortex'", client=client).collect(
            memory_gb=4,
            max_parallelism=2,
        )
        filtered = sl.sql(
            "SELECT * FROM 'orders.vortex' WHERE value >= 3",
            client=client,
        ).collect(memory_gb=4, max_parallelism=2)
        ...
        self.assertEqual(project.rows_projected, 10)
        self.assertEqual(project.projected_columns, ("metric",))
        self.assertEqual(filtered.command, "vortex-filter-project")
        self.assertEqual(filtered.rows_selected, 3)
        for report in (count, count_where, project, filtered):
            self.assertIsInstance(report, sl.VortexWorkflowExecutionReport)
            self.assertTrue(report.runtime_execution)
    ...
    def test_session_sql_vortex_collect_passes_resource_args(self) -> None:
        binary = self.fake_cli(
            textwrap.dedent(
                """
                import json, sys
        ...
        session = sl.ShardLoomSession(
            ShardLoomClient(binary=binary),
            session_id="sql-vortex-session",
        )

        report = session.sql("SELECT metric FROM 'orders.vortex'").collect(
            memory_gb=7,
            max_parallelism=2,
        )

        self.assertIsInstance(report, sl.VortexWorkflowExecutionReport)
        self.assertEqual(report.command, "vortex-project")
        self.assertEqual(report.projected_columns, ("metric",))
        self.assertFalse(report.fallback_attempted)

    def test_session_sql_local_source_limit_chain_collect_invokes_sql_smoke(self) -> None:
        statement = "SELECT id FROM 'target/input.csv' WHERE id >= 1 LIMIT 2"
        binary = self.fake_cli(
            textwrap.dedent(
                f"""
                ...
                print(json.dumps({{
                    ...
                    "fields": [
                        ...
                        {{"key": "output_row_count", "value": "2"}},
                        {{"key": "selected_row_count", "value": "2"}},
                        {{"key": "source_state_id", "value": "session-sql-source"}},
                        {{"key": "source_state_digest", "value": "fnv64:session-source"}},
                        {{"key": "source_schema_digest", "value": "fnv64:session-schema"}},
                        {{"key": "plan_digest", "value": "fnv64:session-plan"}},
                        {{"key": "fallback_attempted", "value": "false"}},
                        {{"key": "external_engine_invoked", "value": "false"}},
                        {{"key": "claim_gate_status", "value": "fixture_smoke_only"}}
                    ],
        ...
        session = sl.ShardLoomSession(
            ShardLoomClient(binary=binary),
            session_id="sql-limit-session",
        )

        workflow = session.sql("SELECT id FROM 'target/input.csv' WHERE id >= 1").limit(2)
        report = workflow.collect()
    ...
    def test_session_local_csv_query_builder_collect_limit_parameter_invokes_sql_smoke(self) -> None:
        statement = "SELECT id FROM 'target/input.csv' LIMIT 2"
        binary = self.fake_cli(
            textwrap.dedent(
                f"""
                ...
                print(json.dumps({{
                    ...
                    "fields": [
                        ...
                        {{"key": "output_row_count", "value": "2"}},
                        {{"key": "selected_row_count", "value": "2"}},
                        {{"key": "source_state_id", "value": "session-frame-source"}},
                        {{"key": "source_state_digest", "value": "fnv64:session-frame-source"}},
                        {{"key": "source_schema_digest", "value": "fnv64:session-frame-schema"}},
                        {{"key": "plan_digest", "value": "fnv64:session-frame-plan"}},
                        {{"key": "fallback_attempted", "value": "false"}},
                        {{"key": "external_engine_invoked", "value": "false"}},
                        {{"key": "claim_gate_status", "value": "fixture_smoke_only"}}
                    ],
        ...
        session = sl.ShardLoomSession(
            ShardLoomClient(binary=binary),
            session_id="frame-limit-session",
        )
    ...
    def test_vortex_query_builder_filter_limit_uses_local_primitive_runtime(self) -> None:
        binary = self.fake_cli(
            textwrap.dedent(
                """
                import json, sys
                ...
                print(json.dumps({
                    ...
                    "fields": [
                        ...
                        {"key": "filter_local_execution_result_known", "value": "true"},
                        {"key": "filter_local_execution_rows_scanned", "value": "10"},
                        {"key": "filter_local_execution_rows_selected", "value": "5"},
                        {"key": "filter_local_execution_fallback_attempted", "value": "false"},
                        {"key": "external_engine_invoked", "value": "false"}
                    ],
                }))
        ...
        self.assertIsInstance(report, sl.VortexWorkflowExecutionReport)
        self.assertEqual(report.command, "vortex-filter")
        self.assertEqual(report.rows_selected, 5)
        self.assertTrue(report.runtime_execution)
        self.assertTrue(report.data_read)
        self.assertFalse(report.fallback_attempted)

    def test_sql_vortex_project_and_star_limits_use_local_primitive_runtime(self) -> None:
        binary = self.fake_cli(
            textwrap.dedent(
                """
                import json, sys
                ...
                print(json.dumps({
                    ...
                    "fields": [
                        ...
                        {"key": "project_local_execution_projected_columns", "value": columns},
                        {"key": "project_local_execution_fallback_attempted", "value": "false"},
                        {"key": "external_engine_invoked", "value": "false"}
                    ],
                }))
        ...
        project = sl.sql("SELECT metric FROM 'orders.vortex' LIMIT 5", client=client).collect()
        star = sl.sql("SELECT * FROM 'orders.vortex' LIMIT 5", client=client).collect()

        self.assertIsInstance(project, sl.VortexWorkflowExecutionReport)
        self.assertEqual(project.command, "vortex-project")
        self.assertEqual(project.rows_projected, 5)
        self.assertEqual(project.projected_columns, ("metric",))
        self.assertIsInstance(star, sl.VortexWorkflowExecutionReport)
        self.assertEqual(star.command, "vortex-project")
        self.assertEqual(star.projected_columns, ("*",))
        self.assertFalse(project.fallback_attempted)
        self.assertFalse(star.fallback_attempted)

    def test_python_and_session_vortex_star_and_filter_project_limits_use_local_runtime(self) -> None:
        binary = self.fake_cli(
            textwrap.dedent(
                """
                import json, sys
                ...
                if primitive == "project":
                    ...
                    fields = [
                        ...
                        {"key": "project_local_execution_result_known", "value": "true"},
                        {"key": "project_local_execution_rows_projected", "value": "5"},
                        {"key": "project_local_execution_projected_columns", "value": "*"},
                        {"key": "project_local_execution_fallback_attempted", "value": "false"},
                        {"key": "external_engine_invoked", "value": "false"}
                    ]
                elif primitive == "filter_project":
                    ...
                    fields = [
                        ...
                        {"key": "filter_project_local_execution_result_known", "value": "true"},
                        {"key": "filter_project_local_execution_rows_scanned", "value": "10"},
                        {"key": "filter_project_local_execution_rows_selected", "value": "5"},
                        {"key": "filter_project_local_execution_rows_projected", "value": "5"},
                        {"key": "filter_project_local_execution_projected_columns", "value": "metric"},
                        {"key": "filter_project_local_execution_fallback_attempted", "value": "false"},
                        {"key": "external_engine_invoked", "value": "false"}
                    ]
                else:
        ...
        star = sl.read_vortex("orders.vortex", client=client).select("*").limit(5).collect()
        session = sl.ShardLoomSession(client, session_id="vortex-session")
        filtered = (
            session.read_vortex("orders.vortex")
            .filter("gte:value:3")
            .select("metric")
            .limit(5)
            .collect(memory_gb=6, max_parallelism=2)
        )

        self.assertEqual(star.command, "vortex-project")
        self.assertEqual(star.projected_columns, ("*",))
        self.assertEqual(filtered.command, "vortex-filter-project")
        self.assertEqual(filtered.projected_columns, ("metric",))
