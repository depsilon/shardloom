...
LANES: dict[str, Lane] = {
    ...
    "pyspark": Lane(
        ...
        module="pyspark",
        requires_java=True,
        availability_hint="PySpark local baseline module",
    ),
    "spark-default": Lane(
        "spark-default",
        "core_local_baseline",
...
PROFILES: dict[str, BenchmarkProfile] = {
    ...
    "full_local": BenchmarkProfile(
        ...
        optional_lanes=(),
        required_formats=("csv", "jsonl", "parquet", "arrow-ipc", "avro", "orc"),
        optional_formats=(),
        required_scenarios=(
            "csv/file ingest",
            "selective filter",
        ...
        hardware_class="cpu_local",
        object_store_runtime_required=False,
        claim_boundary="local_comparative_broad_formats_not_claim_grade",
    ),
