...
and the current materialization/scan evidence. The current benchmark operators still
materialize Vortex-derived arrays after scan, so these rows are not broad SQL/DataFrame
performance claims.
