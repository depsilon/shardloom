...
group/distinct` prepared/native paths use Vortex scan filter/projection pushdown where applicable
...
`category`/`metric` columns into ShardLoom-native string grouping state. None of these paths are
