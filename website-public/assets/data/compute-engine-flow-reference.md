...
4D/5G/F1 closeout note: current release-gated admitted semantics now include `matrix_row_count=43`
and `executable_fixture_count=25`, including composed string functions, temporal arithmetic/
