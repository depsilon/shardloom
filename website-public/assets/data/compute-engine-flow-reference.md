...
and `executable_fixture_count=44`, including scoped UTF-8 regex predicates, composed string functions, temporal arithmetic/
...
union dtype, binary-source, scalar-left multi-column IN-subquery, unbound qualified or broad correlated subquery shapes, and
...
IN-subquery, unbound qualified or broad correlated, and other non-admitted
