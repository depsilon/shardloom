...
4D/5G/F1 closeout note: current release-gated admitted semantics now include `matrix_row_count=48`
and `executable_fixture_count=33`, including scoped UTF-8 regex predicates, composed string functions, temporal arithmetic/
