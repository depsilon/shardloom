...
4D/5G closeout note: current release-gated admitted semantics now include `matrix_row_count=18`
...
aggregates, mixed window row_number/rank/lag/ntile semantics, and multi-key joins. Broader window
frames/value functions, advanced subqueries, complex dtypes, decimal/timezone/collation semantics,
and broad encoded-kernel coverage remain split follow-up items rather than hidden side lanes.
