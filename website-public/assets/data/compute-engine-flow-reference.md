...
4D/5G/F1/F2 closeout note: current release-gated admitted semantics now include `matrix_row_count=28`
...
aggregates, mixed window row_number/rank/lag/ntile semantics, multi-key joins, and twelve
deterministic unsupported diagnostics for decimal, timezone, interval, regex, collation, list/array,
struct/row, variant, union, and binary-source families. Broader window frames/value functions,
advanced subqueries, parent/child complex value admission, schema-field identity admission, and broad
